...
\def\txtZnacka{\textup{\textbf{!}}} % symbol vkladany jako upozorneni
\newcommand{\zalmVersUpozorneni}[1]{%
  \stepcounter{zalmVersUpozorneni}%
  \ifnumequal{#1}{3}{%
    \putmarginpar{znac:\arabic{zalmVersUpozorneni}}{\small{\txtZnacka\txtZnacka}}%
  }{% else
    \putmarginpar{znac:\arabic{zalmVersUpozorneni}}{\small{\txtZnacka}}%
  }%
}
