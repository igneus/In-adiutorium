...
\newcommand{\rubrikaPrvniDoxologie}{%
  \rubrikaPo{Toto zakončení Sláva Otci se připojuje na konci všech žalmů a kantik.}
}
...
\newcommand{\rubrikaHymnus}[2]{%
  \rubrika{Hymnus \textnormal{#1,} hymnář, str. #2.}
}
