...
\newcommand{\zalmRef}[1]{
  \mbox{\smallŽalm #1, str. \pageref{z#1}}}

\newcommand{\textRef}[2]{
  \mbox{\small#2, str. \pageref{#1}}}
...
\textit{Krátké verše.} Některé verše několika žalmů a kantik jsou příliš krátké a na některé,
...
Jsou označeny vykřičníky na okraji stránky.
