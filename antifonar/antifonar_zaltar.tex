...
% Poznamky k netypickym versum zalmu:
% * První poloverš je příliš krátký pro mediaci většiny modů.
% * Druhý poloverš je příliš krátký pro kterýkoli nápěv kromě IV.g.
% * První poloverš je příliš krátký pro všechny nápěvy.
...
Poznámka: Za posledním veršem každého žalmu je \uv{verš} u\-po\-zor\-ňu\-jí\-cí,
že se má přidat doxologie. V liturgických obdobích, kdy se žalmy modlitby uprostřed
dne zpívají s jedinou antifonou, je možné (a snad dokonce žádoucí)
...
{\footnotesize \noindent \textit{(pátek 1. týdne, pátek 3. týdne)}}
