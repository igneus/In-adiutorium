...
Další potíží (ovšem potíží známou i v psalmodii latinské) je nestejná délka
poloveršů, přičemž některé poloverše nejsou dost dlouhé pro všechny
psalmodické formule. Na verše, které mají první ze dvou přízvuků již 
...
(který není žalmem ani kantikem a má svou vlastní jedinečnou melodii,
ale je možné a \uv{tradicí posvěcené} ho tehdy, když nejsou dány podmínky
pro jeho zpěv podle vlastního nápěvu, zpívat na způsob žalmu).
...
\label{kantiz61cii}
\input{generovane/zaltar/kantikum_iz61cii.tex}s
\label{kantiz62}
