...
% 14107934 is the width of the first column (in sp)
% 1.4cm and 4.2cm are values one has to find by trying
\def\putmarginpar#1#2{%
  \zsavepos{#1}%
  \ifnum14107934>\number\zposx{#1}%
     \hbox to 0pt{\hskip\dimexpr-\zposx{#1}sp +1.4cm \relax#2}%
  \else
     \hbox to 0pt{\hskip4.2cm #2}%
  \fi%
}

% Places a warning symbol (bold exclamation mark) next to the
% psalm verse. Two-columned layout is expected.
