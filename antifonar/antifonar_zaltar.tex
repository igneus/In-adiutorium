...
\ranniChvaly
\input{generovane/zalm51.tex}
\input{generovane/kantikum_iz45.tex}
\rubrika{Pokud se následující žalm zpíval jako invitatorium,
nahradí se zde žalmem 95, str. \pageref{zalm24}.}
\input{generovane/zalm100.tex}

\modlitbaUprostredDne
\input{generovane/zalm119dalet.tex}
\input{generovane/zalm26.tex}
\input{generovane/zalm28.tex}

\nespory
\input{generovane/zalm41.tex}
\input{generovane/zalm46.tex}
\input{generovane/kantikum_zj15.tex}

\nadpisDen{Sobota}

\ranniChvaly
\input{generovane/zalm119kof.tex}
\input{generovane/kantikum_ex15.tex}
\input{generovane/zalm117.tex}

\modlitbaUprostredDne
\input{generovane/zalm119he.tex}
\input{generovane/zalm34i.tex}
\input{generovane/zalm34ii.tex}
...
\nesporyI
\input{generovane/zalm119nun.tex}
\input{generovane/zalm16.tex}
\input{generovane/kantikum_fp2.tex}

\ranniChvaly
\input{generovane/zalm118.tex}
\input{generovane/kantikum_dan3ii.tex}
\input{generovane/zalm150.tex}

\modlitbaUprostredDne
\input{generovane/zalm23.tex}
\input{generovane/zalm76i.tex}
\input{generovane/zalm76ii.tex}

\nesporyII
\input{generovane/zalm110.tex}
\input{generovane/zalm115.tex}
\input{kantikum_zj19.tex}

\nadpisDen{Pondělí}

\ranniChvaly
\input{generovane/zalm42.tex}
\input{generovane/kantikum_sir36.tex}
\input{generovane/zalm19a.tex}

\modlitbaUprostredDne
\input{generovane/zalm119vau.tex}
\input{generovane/zalm40i.tex}
\input{generovane/zalm40ii.tex}

\nespory
\input{generovane/zalm45i.tex}
\input{generovane/zalm45ii.tex}
\input{generovane/kantikum_ef1.tex}

\nadpisDen{Úterý}

\ranniChvaly
\input{generovane/zalm43.tex}
\input{generovane/kantikum_iz38.tex}
\input{generovane/zalm65.tex}

\modlitbaUprostredDne
\input{generovane/zalm119zajin.tex}
\input{generovane/zalm53.tex}
\input{generovane/zalm54.tex}

\nespory
\input{generovane/zalm49i.tex}
\input{generovane/zalm49ii.tex}
\input{generovane/kantikum_zj4.tex}
