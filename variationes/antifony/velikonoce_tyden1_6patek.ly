...
\score {
  \relative c'' {
    ...
    \choralniRezim
    a4 c d e c c( d) d \barMaior
    d \mark\sipka c( b a g) a( g) \barMin f g a a( c b) g( a) a \barMaior
...
\score {
  \relative c'' {
    ...
    \choralniRezim
    a4 c d e c c( d) d \barMaior
    d c( b a g) a( g) \barMin f g a \mark\sipka b( c a) g( a) a \barMaior
    g a b a \barFinalis
  }
  \addlyrics {
    Pa -- ma -- tuj na mě, Pa -- ne,_*
...
\score {
  \relative c'' {
    \choralniRezim
    \mark\sipka d4 c d e c c( d) d \barMaior
...
\score {
  \relative c'' {
    \choralniRezim
    a4 c d e c c( d) d \barMaior
    d \mark\sipka e( f e d) c( d) \barMin d c b a( b) g g
...
\score {
  \relative c'' {
    \choralniRezim
    \mark\sipka d4 d d d( e) c c( d) d \barMaior
    d c( b a g) a( g) \barMin f g a b( c a) g( a) a \barMaior
    g a b a \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    \choralniRezim
    a4 g a c c c( d) d \barMaior
    d d( e d c) d( c) \barMin a g a c( b) g( a) a \barMaior
    b c a( g) a \barFinalis
  }
  \addlyrics {
    Pa -- ma -- tuj na mě, Pa -- ne,_*
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c( d) d \barMin
    e d c \mark\sipka c( d) d \barMaior
    d-- c d c b a g g \barMin
    a g f( a) g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    ...
    c4 d d \barMin
    e d c d( c) c \barMaior
    a b c a \mark\sipka a g( a) g g \barMin
...
\score {
  \relative c'' {
    ...
    c4 d d \barMin
    e d c d( c) c \barMaior
    a \mark\sipka c c b a g( a) g g \barMin
    f g( a) g g \barFinalis
  }
  \addlyrics {
    O -- prav -- du,_*
...
\score {
  \relative c'' {
    ...
    c4 d d \barMin
    e d c d( c) c \barMaior
    \mark\sipka c d d c b g( a) a( g) g \barMin
    f g( a) g g \barFinalis
  }
  \addlyrics {
    O -- prav -- du,_*
...
\score {
  \relative c' {
    \choralniRezim
    f4 g
    a a g f g g a \barMin
    g f g( a) f \barFinalis
  }
  \addlyrics {
    Služ -- te_*
    Hos -- po -- di -- nu s_ra -- dos -- tí.
...
\score {
  \relative c' {
    \choralniRezim
    f4 g a g f g f d d \barMin
    \mark\sipka c d f( g) f \barFinalis
  }
  \addlyrics {
    Služ -- te_* Hos -- po -- di -- nu s_ra -- dos -- tí.
    A -- le -- lu -- ja.
...
\score {
  \relative c' {
    ...
    \choralniRezim
    d4 d d f e f d( c) c \barMin
    \mark\sipka d f e d c d d \barMaior
    e f d d \barFinalis
  }
  \addlyrics {
    Kris -- tus se pro nás stal chu -- dým,_*
...
\score {
  \relative c' {
    \choralniRezim
    d4 d d f e f d( c) c \barMin
    d f e \mark\sipka c e( f) d d \barMaior
    e c c( d) d \barFinalis
  }
  \addlyrics {
    Kris -- tus se pro nás stal chu -- dým,_*
...
\score {
  \relative c' {
    ...
    \choralniRezim
    d4 d d f e f d( c) c \barMin
    \mark\sipka d d f e d( e) d d \barMaior
    e c c( d) d \barFinalis
  }
  \addlyrics {
    Kris -- tus se pro nás stal chu -- dým,_*
...
\score {
  \relative c' {
    \choralniRezim
    d4 d d f e f d( c) c \barMin
    d \mark\sipka c f e d( e) d d \barMaior
