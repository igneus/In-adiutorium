...
\score {
  \relative c'' {
    ...
    \choralniRezim
    c4 c a c( b g4.) g \barMin
    a4 \mark\sipka f a g g \barMaior
    f g a b c a \barMin
    a c c b c a g( a) g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    ...
    a4 b a g g \barMaior
    f g a a c b \barMin
    b c \mark\sipka c b c a a( g) g \barFinalis
  }
  \addlyrics {
    Vlo -- žím svůj zá -- kon
    do je -- jich srd -- ce,
...
\markup{
  (Úvodní motiv se částečně vrací k první verzi.)
}
\score {
  \relative c'' {
    \choralniRezim
    g4 g a f( g a4.) a \barMin
    a4 b g a a \barMaior
...
\score {
  \relative c'' {
    \choralniRezim
    g4 g \mark\sipka f g( a) a \barMin
    a b g a a \barMaior
    c b c d c a \barMin
    a c c b c a g( a) g \barFinalis
  }
...
\score {
  \relative c'' {
    ...
    a4 a g a g f g a a \barMaior
    g a g g f g a bes a g( a) a \barMaior
    \mark\sipka a( g f) e( f d4.) d \barMin
    d4 f g a a \barMin
    g f e( d) d \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    ...
    \choralniRezim
    a4 a g a g f g a a \barMaior
    \mark\sipka a a g( a) g \barMin f g a bes a g( a) a \barMaior
...
\score {
  \relative c'' {
    ...
    a4 a g a g f g( a) g g \barMaior
    f g g( a) a \barMin a g a bes a g( a) a \barMaior
    a g f \mark\sipka g a g g( f d) d \barMin
    d( e) c c( d) d \barFinalis
  }
  \addlyrics {
    Všech -- no po -- va -- žu -- ji za ško -- du
...
\score {
  \relative c'' {
    \choralniRezim
    a4 a g a g f g( a) g g \barMaior
    f g g( a) a \barMin \mark\sipka g a bes a g g( a) a \barMaior
    a g f g( a) g f d d \barMin
    d( e) c c( d) d \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    ...
    \choralniRezim
    a4 a g a g f g( a) g g \barMaior
    f g \mark\sipka a a \barMin a g a bes a g( a) a \barMaior
...
\score {
  \relative c'' {
    \choralniRezim
    a4 a g a g f \mark\sipka a g g \barMaior
    f g \mark\sipka a a g a a bes a g( a) a \barMaior
    a g f g( a) g f d d \barMin
    d( e) c c( d) d \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    \choralniRezim
    a4 a g a b g g a a \barMaior
    g f e e \barMin d e f g f g( a) a \barMaior
    a a g a b g e e \barMin
...
\markup\justify{
  LH cituje \make-bible-link "Žid 5, 8" ;
  DMC volně cituje \make-bible-link "Flp 2, 8"
}
...
\score {
  \relative c'' {
    \choralniRezim
    a4 c( d) d \mark\sipka \barMin d e( d c) c( d) d4.( a) \barMin
    a4( b g) g( a) a \barFinalis
  }
  \addlyrics {
    Syn Bo -- ží byl po -- sluš -- ný
...
\score {
  \relative c'' {
    \zvyraznovacZelenyII
    \choralniRezim
    d4 d c d \mark\sipka d( e d) c( d) d4.( a) \barMin
    a4( b g) g( a) a \barFinalis
  }
  \addlyrics {
    Syn Bo -- ží byl po -- sluš -- ný
  ...
  \header {
    ...
    psalmus = "Flp 2"
    id = "ne-1ne-a3"
    fial = "pust_triduum.ly#ct-resp?konec=12"
    piece = \markup {\sestavTitulek}
  }
}
...
\score {
  \relative c' {
    \choralniRezim
    \mark\sipka d4 f d d e( f) d( c) c \barMin
    d( f e) c( d) d \barFinalis
  }
  \addlyrics {
    Syn Bo -- ží byl po -- sluš -- ný
...
\score {
  \relative c' {
    \choralniRezim
    c4 c( d) d \barMin
    \mark\sipka f f f e c d d \barFinalis
  }
  \addlyrics {
    Můj Bo -- že,
    stal ses mým po -- moc -- ní -- kem.
...
\score {
  \relative c' {
    ...
    \choralniRezim
    c4 c( d) d \barMin
    f \mark\sipka g f e c d d \barFinalis
  }
  \addlyrics {
    Můj Bo -- že,
    stal ses mým po -- moc -- ní -- kem.
...
\score {
  \relative c' {
    \choralniRezim
    c4 c( d) d \barMin
    f g \mark\sipka g f e d d \barFinalis
  }
  \addlyrics {
    Můj Bo -- že,
    stal ses mým po -- moc -- ní -- kem.
...
\score {
  \relative c' {
    \choralniRezim
    c4 d( f) f \barMin
    \mark\sipka g g g f e d d \barFinalis
  }
  \addlyrics {
    Můj Bo -- že,
    stal ses mým po -- moc -- ní -- kem.
...
\score {
  \relative c'' {
    \zvyraznovacModry
    \choralniRezim
    a4 \mark\sipka g a( b c) a a \barMaior
    \mark\sipka b a g( a) e e \barMin
    d c \mark\sipka d( f e) d( e) e \barFinalis
  }
  \addlyrics {
    Při -- šla ho -- di -- na,
    kdy Syn člo -- vě -- ka
...
\markup\justify{
  Nejde o adaptaci nějaké konkrétní verze, ale zejm. začátek
  se přiznává k modelu známému z pramenů.
}
\score {
  \relative c' {
    \zvyraznovacSedy
...
\score {
  \relative c' {
    \choralniRezim
    d4 d c f( g) g( a) a \barMin g( f) g( a) g g \barMaior
    a a g f g( a g) \mark\sipka f( e d4.) d \barMin
...
\score {
  \relative c' {
    \choralniRezim
    d4 d c f( g) g( a) a \barMin g( f) g( a) g g \barMaior
    a a g f \mark\sipka g( a) f( e d) d( c) \barMin
...
\score {
  \relative c' {
    \choralniRezim
    d4 d c f( g) g( a) a \barMin g( f) g( a) g g \barMaior
    \mark\sipka f g a a a( c a) g( a) g( f d) \barMin
    d( e c) c d d \barFinalis
  }
  \addlyrics {
    Ja -- ko byl vy -- vý -- šen had na pouš -- ti,
...
\score {
  \relative c' {
    \choralniRezim
    d4 d c f( g) g( a) a \mark\sipka g b( c) a a \barMaior
    a a g f e f d
    c e( f) d d \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c' {
    \choralniRezim
    d4 d c f( g) g( a) a \mark\sipka \barMin c b( c) a a \barMaior
    a a g f e f d
    c e( f) d d \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c' {
    \choralniRezim
    d4 d c f( g) g( a) a \mark\sipka a g( f) e e \barMaior
    e f d c d( f g a) g( f e4.) e4 \barMin
...
\score {
  \relative c' {
    ...
    e f d c \mark\sipka d f f( e d) \barMin
    d( e c) c d d \barFinalis
  }
  \addlyrics {
    Ja -- ko byl vy -- vý -- šen had na pouš -- ti,
...
\score {
  \relative c' {
    ...
    \choralniRezim
    d4 d c f( g) g( a) a a g( f) e e \barMaior
    e f d c \mark\sipka d( f) f( g) g \barMin
    a f( e) c( d) d \barFinalis
  }
  \addlyrics {
    Ja -- ko byl vy -- vý -- šen had na pouš -- ti,
    tak mu -- sí být vy -- vý -- šen
...
\score {
  \relative c' {
    \choralniRezim
    d4 d c f( g) g( a) a a g( f) e e \barMaior
    e f d c d( f) \mark\sipka f( e) d( c) \barMin
    d( f e) c( d) d \barFinalis
  }
  \addlyrics {
    Ja -- ko byl vy -- vý -- šen had na pouš -- ti,
...
\score {
  \relative c' {
    \choralniRezim
    d4 d c f( g) g( a) a a g( f) e e \barMaior
    e f g g \mark\sipka g( a) f( e d4.) d4 \barMin
    c e( f) d d \barFinalis
  }
  \addlyrics {
    Ja -- ko byl vy -- vý -- šen had na pouš -- ti,
...
\score {
  \relative c' {
    \choralniRezim
    d4 d c f( g) g( a) a a g( f) \mark\sipka f( g) g \barMaior
    a a g f e f d
    c e( f) d d \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c' {
    ...
    \choralniRezim
    d4 d d c( d) d( f) f \barMin
    \mark\sipka g f( e) d d( c) \barMaior
    d f f f g g f
...
\score {
  \relative c' {
    \choralniRezim
    d4 d d c( d) d( f) f \barMin
    g f( e) d d( c) \barMaior
    d f \mark\sipka e f d c c
...
\score {
  \relative c' {
    \choralniRezim
    e4 e d e( g) g( a) a \mark\sipka \barMin
    g( a) b( g) g( a) a \barMaior
    b a g a g e e \barMin
    f( e) d e e \barFinalis
  }
  \addlyrics {
...
\markup\justify{
  (V latině skoro doslovný citát \make-bible-link "Iz 31, 5" ,
  v češtině je zvolené řešení asi víceméně nejlepší možné.)
}
...
\score {
  \relative c' {
    \zvyraznovacModry
    \choralniRezim
    d4 d d f e d f( g) \mark\sipka a a \barMin
    a4 c b g g( a) a \barMaior
...
\score {
  \relative c'' {
    ...
    \mark\sipka d e d c( b a) a \barMin
    g a a \barFinalis
  }
  \addlyrics {
    Ne -- je -- nom já
...
\score {
  \relative c'' {
    ...
    d f f( g) g \barMin
    g f g( a) g f( d) d \barMaior
    \mark\sipka f g( a g) f( g) g( f) f \barMin
    g g g a( g) a f f \barFinalis
  }
  \addlyrics {
    Je -- žíš ře -- kl
    zá -- stu -- pům Ži -- dů a ve -- le -- kně -- žím:
...
\score {
  \relative c'' {
    ...
    g f g( a) g f( d) d \barMaior
    f e c d c \barMin
    d f f \mark\sipka e c c( d) d \barFinalis
  }
  \addlyrics {
    Je -- žíš ře -- kl
    zá -- stu -- pům Ži -- dů a ve -- le -- kně -- žím:
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c c a c c b( a g) \barMin
    f( g a4.) g \barMin f4 g f \barFinalis
  }
  \addlyrics {
    Dří -- ve než byl A -- bra -- hám,
    já jsem, pra -- ví Pán.
...
\score {
  \relative c' {
    \choralniRezim
    d4 d c d d f f \barMin
    \mark\sipka e( f d4.) d \barMin c4 d d \barFinalis
  }
  \addlyrics {
    Dří -- ve než byl A -- bra -- hám,
    já jsem, pra -- ví Pán.
...
\score {
  \relative c' {
    ...
    \choralniRezim
    d4 d c d d f f \barMin
    \mark\sipka f( g) d \barMin c d d \barFinalis
  }
  \addlyrics {
    Dří -- ve než byl A -- bra -- hám,
    já jsem, pra -- ví Pán.
...
\score {
  \relative c' {
    \choralniRezim
    d4 d c d d f f \barMin
    f( g) d \barMin \mark\sipka e c d \barFinalis
  }
  \addlyrics {
    Dří -- ve než byl A -- bra -- hám,
    já jsem, pra -- ví Pán.
...
\score {
  \relative c' {
    \choralniRezim
    d4 d c d d f f \barMin
    \mark\sipka g( f d4.) d \barMin c4 d d \barFinalis
  }
  \addlyrics {
    Dří -- ve než byl A -- bra -- hám,
    já jsem, pra -- ví Pán.
...
\score {
  \relative c' {
    \choralniRezim
    d4 d c d d f f \barMin
    \mark\sipka g( f g4.) d4 \barMin c4 d d \barFinalis
  }
  \addlyrics {
    Dří -- ve než byl A -- bra -- hám,
    já jsem, pra -- ví Pán.
...
\score {
  \relative c' {
    \choralniRezim
    f4 f \mark\sipka e d f( g a) g g \barMin
    f( g) d \barMin c d d \barFinalis
  }
  \addlyrics {
    Dří -- ve než byl A -- bra -- hám,
...
\score {
  \relative c' {
    \choralniRezim
    f4 f g f a g g \barMin
    f d f( g) g4. f \barFinalis
  }
  \addlyrics {
    Dří -- ve než byl A -- bra -- hám,
    já jsem, pra -- ví Pán.
...
\score {
  \relative c' {
    ...
    d d d f g f e d d \barMaior
    f g f e( d c) \barMin
    d f \mark\sipka d c( d) d \barFinalis
  }
  \addlyrics {
    U -- ká -- zal jsem vám
    mno -- ho do -- brých skut -- ků, pra -- ví Pán.
...
\markup\justify{
  ...
  ukázala tahle. Když se během dne přistihnu, jak si nějakou antifonu zpívám,
  je to znamení, že nejspíš nebude tak docela špatná.)
}
\score {
  \relative c' {
    \zvyraznovacSedy
...
\score {
  \relative c'' {
    ...
    \choralniRezim
    g4 a c d d \barMin
    d d c d e \mark\sipka c c d d \barMaior
    d b c a( g) \barMin
...
\score {
  \relative c' {
    \choralniRezim
    d4 c d f f e f d( c) \barMin
    \mark\sipka d c d d( f) f \barMaior
    g g f( e d) d( c) \barMin
    d f e c( d) d \barFinalis
  }
  \addlyrics {
    Jest -- li -- že ne -- vě -- ří -- te mně,
...
\score {
  \relative c'' {
    \choralniRezim
    a4 a a( c) b c( d) d \barMaior
    \mark\sipka d d d( f) e d( c) c d c b( c a) a \barMin
    g( f) g( a) a g g \barFinalis
  }
  \addlyrics {
    Je -- žíš u -- mřel pro -- to,
...
\score {
  \relative c'' {
    ...
    d d d( f) e d( c) c d c b( c a) a \barMin
    g( f) g( a) a g g \barFinalis
  }
  \addlyrics {
    Je -- žíš u -- mřel pro -- to,
...
\score {
  \relative c'' {
    ...
    f g a( c) b a( g) g a f g( a g) g \barMin
...
\score {
  \relative c'' {
    ...
    g a a( c) b a( g) g a( b) g e e \barMin
...
\score {
  \relative c' {
    \choralniRezim
    e4 e e( f) e g( a) a \barMaior
    a g b c a a g f e( f d) d \barMin
    c( d) d( f) e d( e) e \barFinalis
  }
  \addlyrics {
    Je -- žíš u -- mřel pro -- to,
    a -- by roz -- ptý -- le -- né Bo -- ží dě -- ti
