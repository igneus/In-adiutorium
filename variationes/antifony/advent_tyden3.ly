...
\score {
  \relative c'' {
    ...
    a4 b c d d \barMin
    e d c f e d c d d \barMaior
    d( c d) c( b a4.) a \barMin f4 g a b( c a) g( a) a \barMaior
    g a b a \barFinalis
  }
  \addlyrics {
    Je -- ru -- za -- lé -- me,
...
\score {
  \relative c'' {
    ...
    a4 b c d d \barMin
    e d c f e d c d d \barMaior
    d( c d) c( b a) a \barMin f g a b( c a) \mark\sipka a( g) g \barMaior
...
\score {
  \relative c'' {
    ...
    g4 a c c( d) d \barMin
    e d c f e d c d d \barMaior
    \mark\sipka c( d) c( a g) g \barMin f g a b( c a) g( a) a \barMaior
    g a b a \barFinalis
  }
  \addlyrics {
    Je -- ru -- za -- lé -- me,
...
\score {
  \relative c' {
    \choralniRezim
    f4 f( g a bes) a \barMin g a g f e d \barMaior
    d d \mark\sipka f e f f( g a) g( f) e \barMin
    f g a g bes a g f g \barMaior
...
\score {
  \relative c' {
    \choralniRezim
    f4 f( g a bes) a \barMin g a g f e d \barMaior
    d d \mark\sipka f e d f( g a) g( f) e \barMin
    f g a g bes a g f g \barMaior
    g g( a g) f( e) d d d( e c) c d d \barMaior
    f( g a) f( d) f( e) d \barFinalis
  }
...
\score {
  \relative c'' {
    ...
    \choralniRezim
    g4 g g( c a g) g \barMin g f g a g f g a a( g) g \barMaior
    f f d \mark\sipka e( f) g g \barMin a g a( c) b a( g) a \barMaior
    a b c b c c \barMin b c a g g \barMax
    g( a g d) g( a) a \barMin c d c a g \barMaior
    f f f( g) g \barFinalis
  }
...
\score {
  \relative c'' {
    ...
    a b c b c c \barMin b c a g g \barMax
    g( a g d) g( a) a \barMin c d c a g \mark\sipka \barMin
    f f f( g) g \barFinalis
  }
  \addlyrics {
    Kaž -- dá ho -- ra a kaž -- dý pa -- ho -- rek ať je srov -- nán;
...
\score {
  \relative c'' {
    \choralniRezim
    c4 a c( d) d( c) \barMin a g a( c b) g g \barMaior
...
\score {
  \relative c'' {
    \choralniRezim
    c4 a c( d) d( c) \barMin a g a( b a) g g \barMaior
    g f a c b( g) a \barMin a b c( a g) a( g) g \barMaior
    f g g g \barFinalis
  }
  \addlyrics {
    Ze Si -- ó -- nu vze -- jde má spá -- sa
...
\score {
  \relative c'' {
    \choralniRezim
    c4 a c( d) c \barMin a c b g g \barMaior
    g f g a g g \barMin a c b g g \barMaior
...
\score {
  \relative c'' {
    \choralniRezim
    c4 b( g) a( \mark\sipka b) g \barMaior
    f g a c b c a a \barMin
    b a g g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c' {
    ...
    f4 g a g a f e d d \barMaior
    f g f bes a g f g \barMin
    g f g \mark\sipka a f f e( f) f \barFinalis
  }
  \addlyrics {
    Žij -- me spra -- ved -- li -- vě a zbož -- ně,
    % a přitom očekávejme v blažené naději % ne, to zní hrozně; to bych se styděl i vyslovit - natož pro to hledat nápěv...
...
\score {
  \relative c' {
    \choralniRezim
    f4 g a g a f e \mark\sipka f f \barMaior
    f g f bes a g f g \barMin
    g f g a g a f f \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    \choralniRezim
    \mark\sipka c4 c b( c) c d( c) d f e( d) \barMaior
    c c( b) a \barMin
    g f g a a g g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    ...
    \mark\sipka f g( a) a b( c) a \barFinalis
  }
  \addlyrics {
    Ty jsi, Pa -- ne,
...
\score {
  \relative c'' {
    ...
    c d e c d d \barMaior
    d4 a d b c a( g) a g \barMin
    \mark\sipka f g( a) a c( bes) a \barFinalis
  }
  \addlyrics {
    Ty jsi, Pa -- ne,
    ten, kte -- rý má při -- jít,
...
\score {
  \relative c'' {
    ...
    c b a g \mark\sipka a( c) b g g \barFinalis
  }
  \addlyrics {
    Jed -- nej -- te
    po -- dle prá -- va a spra -- ve -- dl -- nos -- ti,
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c g( a g) \barMin
    g f g( a) g f g a a g g \barMaior
