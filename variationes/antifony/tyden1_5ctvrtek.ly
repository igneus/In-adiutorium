...
\score {
  \relative c'' {
    \choralniRezim
    g4 g
    f g( a) g g \barMin a c b a( g) g \barMin
    a g f g g \barFinalis
  }
  \addlyrics {
    Můj lid
...
\score {
  \relative c'' {
    \choralniRezim
    \mark\sipka a4 a g f g( a) a \barMin
    a b c a a \barMin
...
\score {
  \relative c' {
    \choralniRezim
    f4 f g g( a) a \barMin
    a g f \mark\sipka g( a g) f d( c) \barMin
    f g a a g( f) f \barFinalis
  }
  \addlyrics {
    Šťast -- ný je člo -- věk,
