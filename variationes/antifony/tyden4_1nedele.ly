...
\score {
  \relative c' {
    \choralniRezim
    f4( a f g) g( f) \barMin d c d f f f \barMaior
    g \mark\sipka g( a g) \barMin f g a a g( f) f \barFinalis
  }
  \addlyrics {
    Slyš -- te, všich -- ni bo -- ha -- boj -- ní,
    co Bůh pro -- ká -- zal mé du -- ši.
...
\score {
  \relative c' {
    \choralniRezim
    f4( a f g) g( f) \barMin d c d f f f \barMaior
    g g( a g) \barMin f \mark\sipka d f g g( f) f \barFinalis
  }
  \addlyrics {
    Slyš -- te, všich -- ni bo -- ha -- boj -- ní,
    co Bůh pro -- ká -- zal mé du -- ši.
...
\score {
  \relative c' {
    \choralniRezim
    f4( a f g) g( f) \barMin d c d f f f \barMaior
    g \mark\sipka f g a a a g( f) f \barFinalis
  }
  \addlyrics {
    Slyš -- te, všich -- ni bo -- ha -- boj -- ní,
    co Bůh pro -- ká -- zal mé du -- ši.
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c c b( c) a g( f) f( g) g \barMin
    c4 d e d c a g g \barMaior
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c c b( c) a g( f) f( g) g \barMaior
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c c d c b( c) \mark\sipka a a \barMaior
...
\score {
  \relative c'' {
    ...
    d e d c a a \barMin
    c b g a a( g) g \barMaior
    f \mark\sipka g a a a a c b g g \barFinalis
  }
  \addlyrics {
    Bla -- ho -- sla -- ve -- ní,
    kdo lač -- ní a žíz -- ní
...
\score {
  \relative c'' {
    ...
    c4 b c d d \barMin
    d e d c a a \barMin
    c b \mark\sipka a g a( g) g \barMaior
    \mark\sipka f g a a a a g a g g \barFinalis
  }
  \addlyrics {
    Bla -- ho -- sla -- ve -- ní,
    kdo lač -- ní a žíz -- ní
