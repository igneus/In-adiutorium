...
\score {
  \relative c' {
    \choralniRezim
    c4( d) d \barMin
    f e f g \mark\sipka g f e d d \barMaior
    e c c( d) d \barFinalis
  }
  \addlyrics {
    Bo -- že,_*
...
\score {
  \relative c'' {
    ...
    \choralniRezim
    a4 g \barMin
    \mark\sipka g f g a c b g a a \barMaior
...
\score {
  \relative c'' {
    ...
    \choralniRezim
    a4 a g f e( f d) d \barMaior
    \mark\sipka c d f g f d( c) c \barMin d f e d d \barMaior
  ...
  \header {
    ...
    psalmus = "Jer 14"
    id = ""
    fial = "pust_svatytyden.ly#ne-2ne-a3?zacatek&volne"
    piece = \markup {\sestavTitulek}
  }
}
...
\score {
  \relative c' {
    \choralniRezim
    \mark\sipka f4 g a f f( g) g \barMaior
    a g g bes a g( a) g \barMin
    g f e d4. c \barMin
    e4 f d d \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    ...
    \choralniRezim
    g4 a c c b \barMin
    a c c b \mark\sipka g a f e e \barMaior
    f g e e \barFinalis
  }
  \addlyrics {
    Já jsem Hos -- po -- din,_*
...
\score {
  \relative c'' {
    \choralniRezim
    g4 a a c c \barMin
    c \mark\sipka d d c b c a g g \barMin
    f a g g \barFinalis
  }
  \addlyrics {
    Já jsem Hos -- po -- din,_*
