...
\score {
  \relative c'' {
    ...
    a4 a a a g( a) a( c) c \barMin
    d e d c d( e) d d \barMaior
    d c b a \mark\sipka c a( g) g \barMin
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c \mark\sipka c c d c d( e) d \barMin c b a( g) g \barMaior
    f g a a c b g g \barMin
    a g f( g) g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c c c d c d( e) d \barMin c b a( g) g \barMaior
    f g a a \mark\sipka g a c b \barMin
    a g f( g) g \barFinalis
  }
  \addlyrics {
    Roz -- vá -- zal jsi mo -- je pou -- ta, Hos -- po -- di -- ne,
...
\score {
  \relative c'' {
    ...
    a4 a a( f e) \barMin e d e e e f e d d f e f( a) a \barMaior
    a a a a g( a b) a a \barMin g( a) f e e \barMaior
    f g a a g f g g e e \mark\sipka \barMin
    f f d( e) e \barFinalis
  }
  \addlyrics {
    Bo -- ží Syn se na -- u -- čil svým u -- tr -- pe -- ním po -- sluš -- nos -- ti,
...
\score {
  \relative c' {
    ...
    d4 d( f e) g( a) a \barMaior
    a g a a( c a) a( g f) \barMin
    d4.( f) f4( g f) d d \mark\sipka \barMin
    e c d d \barFinalis
  }
  \addlyrics {
    A -- le -- lu -- ja.
...
\score {
  \relative c'' {
    ...
    c4 c d( e d) c( d) \barMaior
    a a g a g f \barMin a g a( g) f \barMaior
    a g f \mark\sipka a( c) c c \barMaior
    c b c( d c) a \barMin a g( a g) f f \barFinalis
  }
  \addlyrics {
    A -- le -- lu -- ja.
...
\markup\justify{
  Latinská antifona (\italic{Alleluia Quem quaeris, mulier})
  kombinuje \make-bible-link "Jan 20, 15" a \make-bible-link "Lk 24, 5" ;
  v DMC je čistý citát z \make-bible-link "Lk 24, 5" .
}
\score {
  \relative c'' {
    \choralniRezim
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c d( e d) c( d) \barMaior
    a a a \mark\sipka g a g f \barMin a g a( g) f \barMaior
    a g \mark\sipka f a( c) c \barMaior
    c b c( d c) a \barMin a g( a g) f f \barFinalis
  }
  \addlyrics {
    A -- le -- lu -- ja.
...
\score {
  \relative c'' {
    ...
    g4 g g g a g a c c \barMin
    c c c d c a a \barMaior
    a a( c) \mark\sipka b( a g4.) g4 \barMin a( g) f( g) g \barMaior
    g f d f( g) a g g \barMaior
    f g( a) g g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    ...
    g4 g g g a g a c c \barMin
    c c c d c a a \barMaior
    a \mark\sipka c b a g g g( a g) \barMin
    g f d f( g) a g g \barMaior
    f g( a) g g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    ...
    g4 g g g a g a c c \barMin
    c c c d c a a \barMaior
    a c b a \mark\sipka g( a) g g \barMin
    g f d f( g) a g g \barMaior
    f g( a) g g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    ...
    g4 g g g a g a c c \barMin
    c c c d c a a \barMaior
    a c b a \mark\sipka g a a( g) \barMin
    g f d f( g) a g g \barMaior
    f g( a) g g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    \choralniRezim
    g4 a c c b a c( d) d d \barMaior
    \mark\sipka c c( d e) c( a) a \barMin
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c c b( a g) g \mark\sipka \barMin f g a a
    a( c) b g g \barMaior
    a g f( g) g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c c \mark\sipka g( a) g \barMin f g a a
    a( c) b g g \barMaior
    a g f( g) g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c b a g \mark\sipka a g f( g) g \barMin
    f g a a
    b a g g \barFinalis
  }
  \addlyrics {
...
\score {
  ...
  \header {
    fons_externus = "volně podle Antiphonale Romanum II, Solesmis 2009, s. 216"
    quid = "2. ant."
    modus = "VIII"
    differentia = "G"
    psalmus = "Žalm 111"
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c a c( b g) g f g g( a) a \barMin
    b c a a
    b a g g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c' {
    ...
    \choralniRezim
    d4 d c f g f( a) a \barMin
    a \mark\sipka b( c a) g g( a) a \barMaior
    a a a g( f d) d \barMin
    f e c d c \barMin
    f e d d \barMaior
    e f d( c) d \barFinalis
...
\score {
  \relative c'' {
    ...
    g( a) g f( d) d \barMax
    d d c( d) d f( e f g) g \barMaior
    \mark\sipka a a g f e f d d \barMin
  ...
  \header {
    ...
    differentia = "a"
    psalmus = ""
    fial = "commune/zazemrele.ly#ne-amag?cast=1-3"
    id = "st-amag"
    piece = \markup {\sestavTitulekBezZalmu}
  }
}
