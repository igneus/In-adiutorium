...
\score {
  \relative c'' {
    \choralniRezim
    c4 c b a b a g a a g g \barMaior
    a a a a a g a g f g g( a) a \barMaior
    a( c) b c( a) g f a g g \barFinalis
  }
  \addlyrics {
    Je -- ží -- šo -- vi by -- lo lí -- to zá -- stu -- pů,
    pro -- to -- že by -- li vy -- sí -- le -- ní a skles -- lí
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c b a b a g a a g g \barMaior
    a a a a a \mark\sipka b c a g a a( g) g \barMaior
    a a f( e) d f g g g \barFinalis
  }
  \addlyrics {
    Je -- ží -- šo -- vi by -- lo lí -- to zá -- stu -- pů,
    pro -- to -- že by -- li vy -- sí -- le -- ní a skles -- lí
...
\score {
  \relative c'' {
    ...
    a a g( a g) f a( c b) a g g \barFinalis
  }
  \addlyrics {
    Je -- ží -- šo -- vi by -- lo lí -- to zá -- stu -- pů,
    pro -- to -- že by -- li vy -- sí -- le -- ní a skles -- lí
...
\score {
  \relative c'' {
    ...
    c4 c c c b c a g f g g \barMaior
    f a c d c d e d c b c( a g) g \barMaior
    a a \mark\sipka g f g a f f \barFinalis
  }
  \addlyrics {
    Je -- ží -- šo -- vi by -- lo lí -- to zá -- stu -- pů,
    pro -- to -- že by -- li vy -- sí -- le -- ní a skles -- lí
...
\score {
  \relative c'' {
    ...
    g4 a c c c( e) d \barMin
    d c d( e) d c d d \barMaior
    e d c( d) \mark\sipka d( c) c \barMin a b c a g g \barMaior
    a-- f g g( a) a \barMin
    a c c b a g( a) g g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    ...
    g4 a c c c( e) d \barMin
    d c d( e) d c d d \barMaior
    \mark\sipka e e d( e) d( c) c \barMin a b c a g g \barMaior
    a-- f g g( a) a \barMin
    a c c b a g( a) g g \barFinalis
  }
  \addlyrics {
...
\markup\justify{
  Text výše, bez \italic{_a_ naleznete,}
  je podle čtyřsvazkového vydání 2005.
  Všechny ostatní sazby (úplné vydání i diurnál z konce osmdesátých let,
  diurnál 2007) mají text s oním _a_,
  shodný z antifonou ze slavnosti Nejsvětějšího Srdce Ježíšova.
  Text bez něj tudíž považuji za chybu konkrétního vydání,
  ne za oficiální znění.
}
...
\score {
  \relative c'' {
    ...
    a b c b a g( a) g g \barMin a f g \barFinalis
  }
  \addlyrics {
    Mé jho ne -- tla -- čí
    a mé bře -- me -- no ne -- tí -- ží, pra -- ví Pán.
...
\score {
  \relative c'' {
    \choralniRezim
    g4 f g( a) a g \barMaior
    a b c \mark\sipka c c b( c) a a \barMin g f g \barFinalis
  }
  \addlyrics {
    Mé jho ne -- tla -- čí
    a mé bře -- me -- no ne -- tí -- ží, pra -- ví Pán.
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c c c c( d c) a a \barMin \mark\sipka b a g g \barFinalis
  }
  \addlyrics {
    Je -- žíš mlu -- vil k_zá -- stu -- pům v_po -- do -- ben -- stvích.
  }
...
\score {
  \relative c'' {
    \zvyraznovacModry
    \choralniRezim
    c4 c c c c( d c) \mark\sipka b g( a) \barMin b a g g \barFinalis
  }
  \addlyrics {
    Je -- žíš mlu -- vil k_zá -- stu -- pům v_po -- do -- ben -- stvích.
  }
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c c c c( d c) b \mark\sipka a( g) \barMin a g f( g) g \barFinalis
  }
  \addlyrics {
    Je -- žíš mlu -- vil k_zá -- stu -- pům v_po -- do -- ben -- stvích.
  }
...
\score {
  \relative c'' {
    \choralniRezim
    \mark\sipka a4 a f g g a a \barMin c b g g \barFinalis
  }
  \addlyrics {
    Je -- žíš mlu -- vil k_zá -- stu -- pům v_po -- do -- ben -- stvích.
  }
...
\score {
  \relative c'' {
    \choralniRezim
    a4 a f g \mark\sipka g( a) a a c b g g \barFinalis
  }
  \addlyrics {
    Je -- žíš mlu -- vil k_zá -- stu -- pům v_po -- do -- ben -- stvích.
  }
...
\score {
  \relative c'' {
    \choralniRezim
    \mark\sipka a4 a g f g g a \barMin c b g g \barFinalis
  }
  \addlyrics {
    Je -- žíš mlu -- vil k_zá -- stu -- pům v_po -- do -- ben -- stvích.
  }
...
\score {
  \relative c'' {
    \choralniRezim
    a4 a f g a c b \barMin a g f( g) g \barFinalis
  }
  \addlyrics {
    Je -- žíš mlu -- vil k_zá -- stu -- pům v_po -- do -- ben -- stvích.
  }
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c d b c a a \barMin g f g g \barFinalis
  }
  \addlyrics {
    Je -- žíš mlu -- vil k_zá -- stu -- pům v_po -- do -- ben -- stvích.
  }
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c d b c a a \barMin \mark\sipka b a g g \barFinalis
  }
  \addlyrics {
    Je -- žíš mlu -- vil k_zá -- stu -- pům v_po -- do -- ben -- stvích.
  }
...
\score {
  \relative c'' {
    \choralniRezim
    c4 b c( d c) c \barMin b( c) a g a g f( g) g \barFinalis
  }
  \addlyrics {
    Je -- žíš mlu -- vil k_zá -- stu -- pům v_po -- do -- ben -- stvích.
  }
...
\score {
  \relative c'' {
    \choralniRezim
    c4 b c( d c) c \barMaior \mark\sipka b( c a) g a( g) \barMin a g f( g) g \barFinalis
  }
  \addlyrics {
    Je -- žíš mlu -- vil k_zá -- stu -- pům v_po -- do -- ben -- stvích.
  }
...
\score {
  \relative c' {
    ...
    \choralniRezim
    c4 d d( a' bes) a \barMin
    a g( a) g \mark\sipka g( f d) \barMaior
...
\score {
  \relative c'' {
    ...
    \choralniRezim
    c4 c b a b a a( g) g \barMin
    f \mark\sipka f g a g g \barMaior
    a( c) c \barMin d c b( c) a a \barMin
    g f a a g g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    ...
    \mark\sipka a a( c) \barMin d c b( c) a a \barMin
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c \mark\sipka c c b a g( a) g \barMin
    f g a a g g \barMaior
    a( c) c \barMin d c b( c) a a \barMin
    g f a a g g \barFinalis
  }
...
\score {
  \relative c'' {
    \choralniRezim
    a4 c d d( e) d d \barMin
    d d c b \mark\sipka g a a( g) \barMaior
    f g g( a) a \barMin
...
\score {
  \relative c'' {
    \choralniRezim
    a4 a a g( a) g g \barMin \mark\sipka f g g e \barMaior
    f g a a g( a) a \barMin
    a c b g g f g a g e e \barMaior
...
\score {
  \relative c'' {
    ...
    f g a a g( a) a \barMin
    a c b g g f g a \mark\sipka a g g \barMaior
    f g a g f e d( e) e \barFinalis
  }
  \addlyrics {
    Ne -- bes -- ké krá -- lov -- ství je ja -- ko kvas,
...
\score {
  \relative c'' {
    ...
    \choralniRezim
    a4 a a g \barMin
    f g g( a) a a \mark\sipka a( c) b g g \barMaior
    f( g a) g f e d( e) e \barFinalis
  }
  \addlyrics {
    Spra -- ved -- li -- ví
...
\score {
  \relative c'' {
    ...
    a a( c) c \barMaior
    c c d c b( c) a a \barMin
    a c c c b a g a f g( a) \mark\sipka a( g) g \barFinalis
  }
  \addlyrics {
    Je -- žíš si za -- vo -- lal své u -- čed -- ní -- ky
    a ře -- kl:
...
\score {
  \relative c'' {
    ...
    a c c c b a g a \mark\sipka a( g) \barMin a( g) f( g) g \barFinalis
  }
  \addlyrics {
    Je -- žíš si za -- vo -- lal své u -- čed -- ní -- ky
    a ře -- kl:
...
\score {
  \relative c'' {
    ...
    g4 g g a a g f g a g-- g
    a a( c) c \barMaior
    c c \mark\sipka c( d) c b( c) a a \barMin
...
\score {
  \relative c' {
    \choralniRezim
    d4 d d f f e d c d c-- c
    d d( f) f \barMaior
    f f g( a) g f( e) d( c) c \barMin
    d f f f e( f d) d c f e c d d \barFinalis
  }
  \addlyrics {
    Je -- žíš si za -- vo -- lal své u -- čed -- ní -- ky
    a ře -- kl:
...
\score {
  \relative c' {
    ...
    d d( f) f \barMaior
    f f g( a) g f( e) d( c) c \barMin
    d f \mark\sipka e d c( d) c d f e c e d \barFinalis
  }
  \addlyrics {
    Je -- žíš si za -- vo -- lal své u -- čed -- ní -- ky
    a ře -- kl:
...
\score {
  \relative c'' {
    \choralniRezim
    a4 a a c c b a g a g-- g
    a a( c) c \barMaior
    c c d( e) d c( b) \mark\sipka a a \barMin
    a c b a g( a) g a \mark\sipka g f g( a) g g \barFinalis
  }
  \addlyrics {
    Je -- žíš si za -- vo -- lal své u -- čed -- ní -- ky
    a ře -- kl:
...
\score {
  \relative c'' {
    ...
    g a a( c) c \barMin
    d( e d) c b a a \barMaior
    a c c \mark\sipka a g f( g) a( g) g \barFinalis
  }
  \addlyrics {
    Je -- žíš vzal pět chle -- bů a dvě ry -- by,
    po -- žeh -- nal je,
...
\score {
  \relative c' {
    ...
    \choralniRezim
    f4 a c c b a c d d \barMaior
    d e d c \mark\sipka b a a \barMaior
    c c \mark\sipka c c a g
    a g f f \barFinalis
  }
  \addlyrics {
    Všich -- ni se na -- jed -- li do -- sy -- ta
...
\score {
  \relative c' {
    \choralniRezim
    d4 d d f e d f( g) g( a) a \barMaior
    a a a a( c) a g( a) a \barMaior
    a a g f d d
    c e d d \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c' {
    \choralniRezim
    d4 d d f e d f( g) g( a) a \barMaior
    a a \mark\sipka g b c a a \barMaior
    a a g f g f
    e f d d \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c' {
    \choralniRezim
    f4( e d4.) d \barMin
    c4 d d d f g g f g( a) g g \barMin
...
\markup{
  Stejnými slovy začíná \fial-link "antifony/mezidobi_nedeleB_02_10.ly#ne6b-rch-ben"
}
