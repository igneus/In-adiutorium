...
\score {
  \relative c'' {
    ...
    c( d) c b a g a \barMaior
    c d( c) d d( c) \barMin
    \mark\sipka a g a c b g g \barMaior
    a g f( g) g \barFinalis
  }
  \addlyrics {
    Ať tě, Bo -- že,
...
\score {
  \relative c' {
    \choralniRezim
    c4 d d( f) f \barMin
    f( g) f e d c d \barMaior
    f f( g) g( f) f \barMin
    f f \mark\sipka e f d c( d) d \barMaior
    e f d d \barFinalis
  }
  \addlyrics {
    Ať tě, Bo -- že,
...
\score {
  \relative c' {
    ...
    f( g) f e d c d \barMaior
    f f( g) g( f) f \barMin
    \mark\sipka d c d f e c( d) d \barMaior
    e f d d \barFinalis
  }
  \addlyrics {
    Ať tě, Bo -- že,
...
\score {
  \relative c'' {
    ...
    c( d) e c c d d \barMaior
    d a( d) b( c) a( g) \barMin
    f g a c b \mark\sipka a( b a4.) a4 \barMaior
...
\score {
  \relative c'' {
    ...
    d a( d) b( c) a( g) \barMin
    f g a c b \mark\sipka a a \barMaior
    b g g( a) a \barFinalis
  }
  \addlyrics {
    Ať tě, Bo -- že,
