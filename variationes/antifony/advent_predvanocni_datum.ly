...
\score {
  \relative c' {
    \choralniRezim
    d4 d d f e d d( e) e \barMin
    f \mark\sipka e d c c e f d c d d \barFinalis
  }
  \addlyrics {
    Ny -- ní se spl -- ni -- lo všech -- no,
    co ře -- kl an -- děl o Pan -- ně Ma -- ri -- i.
...
\score {
  \relative c' {
    \choralniRezim
    d4 d d f e d d( e) e \barMin
    f e d c c d f \mark\sipka d c d d \barFinalis
  }
  \addlyrics {
    Ny -- ní se spl -- ni -- lo všech -- no,
    co ře -- kl an -- děl o Pan -- ně Ma -- ri -- i.
...
\score {
  \relative c'' {
    ...
    d e d c( d) c \barMin b c a g a a \barFinalis
  }
  \addlyrics {
    Ny -- ní se spl -- ni -- lo všech -- no,
    co ře -- kl an -- děl o Pan -- ně Ma -- ri -- i.
...
\score {
  \relative c' {
    ...
    d d d e f d e d( c) \barMaior
    d d a( d) d d e( f) \[ g( a g \] \[ a bes a) \] \barMaior
    a a g f f \mark\sipka g f d e d( c) \barMax
