...
\score {
  \relative c'' {
    \choralniRezim
    \mark\sipka a4 c b a g g \barMaior
    a a a g a \barMin a b c d c a( b) a a \barMaior
    a g a a g f e \barFinalis
  }
  \addlyrics {
    Jan vy -- dal svě -- dec -- tví:
...
\score {
  \relative c'' {
    ...
    a a c c b a c( d) d \barMaior
    d c( b a g) a( g) \barMin a g f g g \barFinalis
  }
  \addlyrics {
    Duch sva -- tý se -- stou -- pil
    ja -- ko ho -- lu -- bi -- ce z_ne -- be
...
\score {
  \relative c'' {
    ...
    \mark\sipka e f a g f e e \barFinalis
  }
  \addlyrics {
    Je -- žíš u -- vi -- děl dva brat -- ry,
    jak vr -- ha -- jí síť do mo -- ře,
...
\score {
  \relative c'' {
    \choralniRezim
    a4 a g( a) a f g g a a \barMin
    f g f \mark\sipka d( e) d d \barMaior
    f e d c c \barMin
    d d c d f( g f) e c( d) d \barFinalis
  }
  \addlyrics {
    Je -- žíš hlá -- sal e -- van -- ge -- li -- um
    o Bo -- žím krá -- lov -- ství
...
\score {
  \relative c' {
    ...
    a g f d( e) d( c) c \barMaior
    d c d d( f) f \barMin
    f f e f \mark\sipka g( a) f( e) d d \barFinalis
  }
  \addlyrics {
    Je -- žíš hlá -- sal e -- van -- ge -- li -- um
    o Bo -- žím krá -- lov -- ství
...
\score {
  \relative c' {
    ...
    \choralniRezim
    f4 g g( a) a g f g( a) g g \barMin
    a g f \mark\sipka e( f) d( c) c \barMaior
    d c d d( f) f \barMin
...
\score {
  \relative c' {
    \choralniRezim
    f4 g g( a) a g f \mark\sipka g g( a) a \barMin
    a g f e( f) \mark\sipka d d( c) \barMaior
    d c d d( f) f \barMin
    g g f \mark\sipka g g( a) g f f \barFinalis
  }
  \addlyrics {
    Je -- žíš hlá -- sal e -- van -- ge -- li -- um
    o Bo -- žím krá -- lov -- ství
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c c( d) c b c a g g \barMin
    a g f g a a \barMaior
    a c( d) b( c) a a \barMin
    a a g f g a a( g) g \barFinalis
  }
  \addlyrics {
    Je -- žíš hlá -- sal e -- van -- ge -- li -- um
...
\score {
  \relative c' {
    ...
    d( e f) d d d c d e( f) d d \barMaior
    a' g g a a c b a( b) a \barMin
    f g g( a) g f \mark\sipka g f e d( e) d d \barFinalis
  }
  \addlyrics {
    Když Je -- žíš u -- vi -- děl zá -- stu -- py,
    vy -- stou -- pil na ho -- ru;
...
\score {
  \relative c' {
    ...
    d( e f) d d d c d e( f) d d \barMaior
    a' g g a a c b a( b) a \barMin
    \mark\sipka a g f( g) f f e( f) d c c d d \barFinalis
  }
  \addlyrics {
    Když Je -- žíš u -- vi -- děl zá -- stu -- py,
    vy -- stou -- pil na ho -- ru;
...
\score {
  \relative c' {
    ...
    a g a g f g g f e d e d d \barMaior
    d( e f) d d d c d e( f) d d \barMaior
    a' g g a \mark\sipka a-- f e d( e) d \barMin
...
\score {
  \relative c' {
    \choralniRezim
    d4 d d f e f g( a) g g \barMin
    a bes a g( a) g g \barMaior
    g a a g f g g f e d e d d \barMaior
    d c d e( f) d c c( d) d d \barMaior
    a' g g a a c b a( b) a \barMin
    f g g( a) a a g( a) f e c d d \barFinalis
  }
  \addlyrics {
...
\score {
  ...
  \header {
    ...
    psalmus = ""
    annus = "A"
    placet = "_nazváni_ netypický postup bez zvláštní hodnoty"
    id = "ne4a-2ne-amag"
    piece = \markup {\sestavTitulekBezZalmu}
  }
}
...
\score {
  \relative c' {
    ...
    \choralniRezim
    d4( a') g g a a a( c) b g a a \barMaior
    f g a a g f \mark\sipka e( f) d( c) c \barMin
...
\score {
  \relative c' {
    \choralniRezim
    d4( a') g g a a a( c) b g a a \barMaior
    f g a a g f e( f) \mark\sipka d d \barMin
...
\score {
  \relative c'' {
    \choralniRezim
    a4 g e g( a) a \barMaior
    \mark\sipka a a a b g a f e \barMin
...
\score {
  \relative c'' {
    \choralniRezim
    a4 g e g( a) a \barMaior
    a a a \mark\sipka g a b g e \barMin
    f g a g f e e \barFinalis
  }
  \addlyrics {
    Vy jste sůl ze -- mě;
...
\score {
  \relative c'' {
    ...
    \choralniRezim
    a4 g e g( a) a \barMaior
    a a a g a \mark\sipka a( b) g4. e \barMin
...
\score {
  \relative c' {
    ...
    d c d d( f) f f( g) f d d \barMaior
    f f e( f) d d f e d e d( a) a \barMaior
...
\score {
  \relative c' {
    ...
    d c d d( f) f g( a) g f f \barMaior
    g f e( f) d d f e d c d( c) c \barMaior
    d c d d( f) f \barMin f f f \mark\sipka e c e( f) d d \barFinalis
  }
  \addlyrics {
    Vy jste svět -- lo svě -- ta,
    ať va -- še svět -- lo sví -- tí li -- dem,
...
\score {
  \relative c' {
    ...
    d c d d( f) f g( a) g f f \barMaior
    g f e( f) d d f e d c d( c) c \barMaior
    d c d d( f) f \barMin f f f \mark\sipka e( f) d c d d \barFinalis
  }
  \addlyrics {
    Vy jste svět -- lo svě -- ta,
    ať va -- še svět -- lo sví -- tí li -- dem,
...
\score {
  \relative c' {
    \choralniRezim
    c4 d d( f) e d( c) c \barMaior
    d c d d( f) f g( a) \mark\sipka f g g \barMaior
    a g f( g) d d \mark\sipka \barMin f e d c d( c) c \barMaior
    d c d d( f) f \barMin f f f g f e( f) d d \barFinalis
  }
  \addlyrics {
    Vy jste svět -- lo svě -- ta,
...
\score {
  ...
  \header {
    ...
    psalmus = ""
    annus = "A"
    placet = "melodie _postavená na podstavec_ říká spíš _odložená pod hrnec_"
    id = "ne5a-2ne-amag"
    piece = \markup {\sestavTitulekBezZalmu}
  }
}
...
\score {
  \relative c'' {
    ...
    c4 c c( d) c b( c) a a \barMin
    c c b a c b a( g) g \barMaior
    \mark\sipka a a g( f) g( a) a \barMin
...
\score {
  \relative c' {
    \choralniRezim
    f4 f g f f( g) f f \barMin
    f g a a g f f( g) g \barMaior
    a g f( e) d d( c) \barMin
...
\score {
  \relative c'' {
    ...
    c d f \mark\sipka f e c c( d) d \barFinalis
  }
  \addlyrics {
    Mi -- luj -- te své ne -- přá -- te -- le
    a mo -- dle -- te se za ty, kdo vás pro -- ná -- sle -- du -- jí.
...
\score {
  ...
  \header {
    ...
    psalmus = ""
    annus = "A"
    placet = "melisma na _ne_beský překáží; _vy_cházet melisma moc dobře nenese"
    id = "ne7a-rch-aben"
    piece = \markup {\sestavTitulekBezZalmu}
  }
}
...
\score {
  \relative c'' {
    ...
    \mark\sipka c b c c( d c) b a a \barMin
    c b g a g g \barMaior
    g a a a f( e d) \barMin
    f g a a a c b a g g \barFinalis
  }
...
\score {
  \relative c'' {
    ...
    d d d d( e) d c( d) d( c) \barMin
    c c b g \mark\sipka g( a g) g \barFinalis
  }
  \addlyrics {
    Buď -- te do -- ko -- na -- lí,
    ja -- ko je do -- ko -- na -- lý
...
\score {
  \relative c'' {
    ...
    g4 a c b c( d) d \barMaior
    d d d d( e) d c( d) d( c) \barMin
    c c b \mark\sipka a g( a g) g \barFinalis
  }
  \addlyrics {
    Buď -- te do -- ko -- na -- lí,
    ja -- ko je do -- ko -- na -- lý
...
\score {
  \relative c'' {
    \choralniRezim
    g4 a c b c( d) d \barMaior
    d \mark\sipka c d e c d d \barMin
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c d( e) d c( d) d( c) \barMaior
    c c a c b a( g) g \barMin
...
\score {
  \relative c' {
    \choralniRezim
    f4 f f e \mark\sipka c e( f) d d \barMaior
    c d d \mark\sipka f e f( g) g \barMin
    g f g( a) g f e( f) d c d( c) c \barMaior
    bes c c( d) d f e f f g f e c( d) d \barFinalis
  }
  \addlyrics {
    Po -- dí -- vej -- te se na ptá -- ky:
    Ne -- se -- jí a -- ni ne -- žnou
...
\score {
  \relative c' {
    ...
    \mark\sipka f d d f e f( g) g \barMin
    g f g( a) g f e( f) d c d( c) c \barMaior
    bes c c( d) d \mark\sipka \barMin f e f \mark\sipka g g f e c( d) d \barFinalis
  }
  \addlyrics {
    Po -- dí -- vej -- te se na ptá -- ky:
    Ne -- se -- jí a -- ni ne -- žnou
...
\score {
  \relative c' {
    \choralniRezim
    f4 f f e c e( f) d d \barMaior
    c d d f e f( g) g \barMin
    \mark\sipka f g a g f e f d d( c) c \barMaior
    bes c c( d) d \barMin f e f f g f e \mark\sipka d d \barFinalis
  }
  \addlyrics {
    Po -- dí -- vej -- te se na ptá -- ky:
    Ne -- se -- jí a -- ni ne -- žnou
...
\score {
  \relative c' {
    \choralniRezim
    f4 f f e c e( f) d d \barMaior
    \mark\sipka f f f g f g( a) a \barMin
    a a g( a) g f g f e d( c) c \barMaior
    d d d( f) f \barMin g f g g a f e c( d) d \barFinalis
  }
  \addlyrics {
    Po -- dí -- vej -- te se na ptá -- ky:
    Ne -- se -- jí a -- ni ne -- žnou
...
\score {
  \relative c'' {
    ...
    a g g a c c( d) d \barMin
    d c d( e) d c b( c) a g a( g) g \barMaior
    f g g( a) a \barMin a g f g a a a g g \barFinalis
  }
  \addlyrics {
    Po -- dí -- vej -- te se na ptá -- ky:
    Ne -- se -- jí a -- ni ne -- žnou
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c c b a c( b) a( g) g \barMaior
    a g g \mark\sipka f g g( a) a \barMin
    c b c( d) c c b( c) a g a( g) g \barMaior
    f g g( a) a \barMin a g f g a a a g g \barFinalis
  }
  \addlyrics {
    Po -- dí -- vej -- te se na ptá -- ky:
...
\score {
  \relative c'' {
    ...
    c b \mark\sipka c d c b c a a( g) g \barMaior
    f g g( a) a \barMin a g f g a a a g g \barFinalis
  }
  \addlyrics {
    Po -- dí -- vej -- te se na ptá -- ky:
...
\score {
  \relative c'' {
    ...
    \mark\sipka a a f( e d) d \barMin f e f g a a a g g \barFinalis
  }
  \addlyrics {
    Po -- dí -- vej -- te se na ptá -- ky:
    Ne -- se -- jí a -- ni ne -- žnou
...
\score {
  \relative c'' {
    \choralniRezim
    c4 b a g g a g f g( a) g g \barMaior
    \mark\sipka f g( a) a a c b c d d( c) \barMin
...
\score {
  \relative c'' {
    \choralniRezim
    c4 b a g( a) g g g( a) f g a a \barMaior
    a c c d e d d \barMaior
    d e d c( b) a a \barMin c b a g( a) g g \barFinalis
  }
  \addlyrics {
    Hle -- dej -- te nej -- pr -- ve Bo -- ží krá -- lov -- ství
    a je -- ho spra -- ve -- dl -- nost
...
\score {
  \relative c'' {
    ...
    c4 b a g( a) g g g( a) f g a a \barMaior
    a c c d e d d \barMaior
    d e d c( b) a a \barMin \mark\sipka a g f g( a) a( g) g \barFinalis
  }
  \addlyrics {
    Hle -- dej -- te nej -- pr -- ve Bo -- ží krá -- lov -- ství
    a je -- ho spra -- ve -- dl -- nost
...
\score {
  \relative c' {
    \choralniRezim
    d4 d f e \mark\sipka d c( d) c c \barMin
    d f e( d) c( d) d \barMin
    f e f g f e d( e d) d \barMaior
    a c d d \barMin
    g f( e) d \barMaior
    d f4.( d) \barMin
    c4 d e( d) d \barFinalis
...
\score {
  ...
  \header {
    ...
    placet = "2 málo zpěvná, únavná, bez spádu"
    id = "ne10a-1ne-amag"
    piece = \markup {\sestavTitulekBezZalmu}
  }
}
...
\score {
  ...
  \header {
    ...
    psalmus = ""
    annus = "A"
    fial = "sanktoral/0921matous.ly#aben?cast=5,6"
    id = "ne10a-1ne-amag"
    piece = \markup {\sestavTitulekBezZalmu}
  }
}
...
\score {
  \relative c'' {
    \choralniRezim
    g4 g a c c a c \mark\sipka c b \barMin a( g f g) g( f) \barMaior
    f g a a a b( c) a g( a) g g \barMaior
    g g f( e d) \barMin d e f g( a) a g g \barFinalis
  }
  \addlyrics {
    Mno -- ho cel -- ní -- ků a hříš -- ní -- ků při -- šlo
    a za -- u -- ja -- li mís -- to u sto -- lu
...
\score {
  \relative c'' {
    \choralniRezim
    g4 g a c c a c c b \barMin a( g f g) g( f) \barMaior
    f g a a a b( c) a g( a) g g \barMaior
    g \mark\sipka a g f e f g( a) a g g \barFinalis
  }
  \addlyrics {
    Mno -- ho cel -- ní -- ků a hříš -- ní -- ků při -- šlo
    a za -- u -- ja -- li mís -- to u sto -- lu
...
\score {
  \relative c'' {
    \choralniRezim
    g4 g a c c a c c b \barMin a( g f g) g( f) \barMaior
    f g a a a \mark\sipka c( d) c b( c) a a \barMaior
...
\score {
  \relative c'' {
    ...
    c c b a g \mark\sipka a b a g g \barFinalis
  }
  \addlyrics {
    Mno -- ho cel -- ní -- ků a hříš -- ní -- ků při -- šlo
    a za -- u -- ja -- li mís -- to u sto -- lu
...
\score {
  \relative c' {
    \zvyraznovacSedy
    \choralniRezim
    \mark\sipka f4 g a c c a c c b \barMin a( g f g) g( f) \barMaior
    f g a a a c( d) c b( c) a a \barMaior
    c c \mark\sipka c c a g a g f f \barFinalis
  }
  \addlyrics {
    Mno -- ho cel -- ní -- ků a hříš -- ní -- ků při -- šlo
    a za -- u -- ja -- li mís -- to u sto -- lu
...
\score {
  \relative c' {
    ...
    f g a a a c( d) c b( c) a a \barMaior
    c c \mark\sipka a g a g f g f f \barFinalis
  }
  \addlyrics {
    Mno -- ho cel -- ní -- ků a hříš -- ní -- ků při -- šlo
    a za -- u -- ja -- li mís -- to u sto -- lu
...
\score {
  \relative c'' {
    \choralniRezim
    g4 a c c c a c c b \barMin c( a g a) a( g) \barMaior
    \mark\sipka f g a a a c( d) c b( c) a a \barMaior
...
\markup\justify{
  Pokus vyjít z antifony, se kterou má text společný motiv.
  Strukturou a kvantitou si ale obě antifony moc podobné nejsou.
}
\score {
  \relative c'' {
    \choralniRezim
    c4 b c d d c d( e) d d \barMin
    c( b g b) a( g) \barMaior
    a f g a a a( c) b c d d \barMaior
    d e c( b a) \barMin
    a g f g( a) a g g \barFinalis
  }
  \addlyrics {
    Mno -- ho cel -- ní -- ků a hříš -- ní -- ků
    při -- šlo
    a za -- u -- ja -- li mís -- to u sto -- lu
    s_Je -- ží -- šem
    a s_je -- ho u -- čed -- ní -- ky.
  }
  \header {
    quid = "ant. k Benedictus"
    modus = "VII"
    ...
    psalmus = ""
    annus = "A"
    fial = "antifony/mezidobi_nedeleC_21_30.ly#ne21c-rch-ben?volne"
    id = "ne10a-rch-aben"
    piece = \markup {\sestavTitulekBezZalmu}
  }
}
