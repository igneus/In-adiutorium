...
\score {
  \relative c'' {
    \choralniRezim
    a4 g a c c d( e) d d \barMin d c b c( a) g( a) a \barFinalis
  }
  \addlyrics {
    Pa -- ma -- tuj, Bo -- že, na svůj lid, kte -- rý sis vy -- vo -- lil.
  }
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c c \mark\sipka c d c \barMin
    b c a g f( g) g \barFinalis
  }
  \addlyrics {
    Hos -- po -- din je všu -- de
