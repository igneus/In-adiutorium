...
\score {
  ...
  \header {
    ...
    differentia = "G"
    psalmus = "Žalm 16"
    placet = "dvě antifony za sebou stejného modu a končící stejným aleluja působí jednotvárně"
    id = "1ne-ant2"
    piece = \markup {\sestavTitulek}
  }
}
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c c c \mark\sipka d b c a \barMin
    c b a( g) g \barMaior
    f a a( g) g \barFinalis
  }
  \addlyrics {
...
\score {
  ...
  \header {
    ...
    differentia = "G"
    psalmus = "Flp 2"
    placet = "_koleno_ jaksi drhne; _Ježíšově_ také nic moc"
    id = "1ne-ant3"
    piece = \markup {\sestavTitulek}
  }
}
...
\score {
  \relative c'' {
    \choralniRezim
    g4 f( g) a( c) c c b( c a4.) a \barMaior
    c4 c d c c b \mark\sipka c a g g \barMin
...
\score {
  \relative c'' {
    \choralniRezim
    g4 f( g) a( c) c c b( c a4.) a \barMaior
    c4 c c( d) c c b c a g g \barMaior
    a a \mark\sipka a a f e d \barMin
    f g a( g) g \barFinalis
  }
  \addlyrics {
    Při Je -- ží -- šo -- vě jmé -- nu
...
\score {
  \relative c'' {
    \choralniRezim
    g4 a c c c \mark\sipka d( e d4.) d \barMaior
...
\score {
  \relative c'' {
    ...
    e4 d c( d) c c b c a g g \barMaior
    a a g f \mark\sipka a c b \barMin
...
\score {
  \relative c'' {
    ...
    e4 d c( d) c c b c a g g \barMaior
    a a g f a c \mark\sipka c \barMin
...
\score {
  \relative c'' {
    ...
    g4 a c c c d( c e d) d \barMaior
    e4 d c( d) c c b c a g g \barMaior
    \mark\sipka a c b c a g g \barMin
    f a g g \barFinalis
  }
  \addlyrics {
    Při Je -- ží -- šo -- vě jmé -- nu
...
\score {
  \relative c' {
    \choralniRezim
    f4 g a g f f( g f d) d \barMaior
    c d d f f \mark\sipka g a a g g  \barMaior
...
\score {
  \relative c'' {
    ...
    \mark\sipka b(^\markup\rubrPust c) a g g \barFinalis
  }
  \addlyrics {
    Bůh vi -- děl všech -- no, co u -- dě -- lal,
    a by -- lo to
...
\score {
  \relative c' {
    \choralniRezim
    f4 f f f g f \mark\sipka g g( a) a \barMaior
    a g f g f d \barMin
    f g g( f) f \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c' {
    \zvyraznovacModry
    \choralniRezim
    f4 f f f g f \mark\sipka g( a) g g \barMaior
...
\score {
  \relative c'' {
    \choralniRezim
    g4 g \mark\sipka f g g( a) a \barMin
    c b g b c a a g g \barMaior
    a g f( g) g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    \choralniRezim
    a4 a c b c d d \barMin
    d d e e d c b c \mark\sipka a( g) g \barMaior
    f g a( g) g \barFinalis
  }
  \addlyrics {
    Kris -- tus je kněz na -- vě -- ky
...
\score {
  \relative c'' {
    \choralniRezim
    a4 a c b c d d \barMin
    d d e \mark\sipka c b g b c a a \barMaior
    b c a( g) a \barFinalis
  }
  \addlyrics {
    Kris -- tus je kněz na -- vě -- ky
...
\score {
  \relative c'' {
    \choralniRezim
    a4 g f a( b c) c( d) d( c) c \barMaior
    d d d( e d) d \barMin \mark\sipka c a b a g g \barMaior
    f g a( g) g \barFinalis
  }
  \addlyrics {
    Kris -- tus je kněz na -- vě -- ky
...
\score {
  \relative c'' {
    \choralniRezim
    \mark\sipka c4 b a g c( d) d( c) c \barMaior
    d d d( e d) d \barMin c( b a) g a( g) f g g \barMaior
    f g( a) g g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    \choralniRezim
    \mark\sipka c4 c b a c( d) d( c) c \barMaior
    d d d( e d) d \barMin c( b a) g a( g) f g g \barMaior
    f g( a) g g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    \choralniRezim
    g4 g a g a c b \barMaior
    c c \mark\sipka c c b a g a g g \barMaior
    f g( a) g g \barFinalis
  }
  \addlyrics {
    Kris -- tus je kněz na -- vě -- ky
...
\markup\justify{
  Melodii první části nejspíš někomu kradu, ale nevím komu/odkud.
}
\score {
  \relative c'' {
    \choralniRezim
    a4 c b g a a g \barMaior
...
\score {
  \relative c'' {
    \choralniRezim
    a4 c b g a a g \barMaior
    \mark\sipka a a g f g f g a g g \barMaior
    f g( a) g g \barFinalis
  }
  \addlyrics {
    Kris -- tus je kněz na -- vě -- ky
...
\score {
  \relative c'' {
    \choralniRezim
    a4 a g f g a a \barMin
    c \mark\sipka a c c c c b a g g \barMaior
    a g f( g) g \barFinalis
  }
  \addlyrics {
    Kris -- tus je kněz na -- vě -- ky
...
\score {
  \relative c'' {
    ...
    a4 a a g f g g4.( a) \barMin
    a4 bes a g f g g \barMin
    f4 e \mark\sipka c( d) d \barFinalis
  }
  \addlyrics {
    Bůh náš je na ne -- be -- sích, u -- či -- nil vše -- chno, co chtěl.
    A -- le -- lu -- ja.
...
\score {
  \relative c' {
    \choralniRezim
    d4 \mark\sipka f g a g f( g) g \barMin
    a4 bes a g f g g \barMaior
    f4 g( a) g g \barFinalis
  }
  \addlyrics {
