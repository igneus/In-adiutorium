...
\score {
  \relative c' {
    \choralniRezim
    \mark\sipka d4 c( d) d( f) f \barMin
    g( f) e d f e d \barMax
    f e( c) d e f \barMin
    e( c) f d4. d4. \barFinalis
  }
...
\score {
  \relative c' {
    \choralniRezim
    d4 c d f g f \mark\sipka d d \barFinalis
  }
  \addlyrics {
    Mé tě -- lo byd -- lí v_bez -- pe -- čí.
  }
