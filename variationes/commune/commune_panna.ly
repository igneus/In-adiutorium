...
\score {
  \relative c' {
    ...
    a a g f g( f d) \barMin d( e) c c( d) d \barFinalis
...
\score {
  \relative c' {
    \choralniRezim
    f4 e d c( d) c \barMin d f g a f f( g) g \barMaior
    a a g f g( f d) d \barMin f e c e( f) d d \barFinalis
...
\score {
  \relative c' {
    \choralniRezim
    f4 e d c( d) c \barMin d f g a f f( g) g \barMaior
    a a g f g( f d) d \barMin \mark\sipka d c d f( e) c( d) d \barFinalis
...
\score {
  \relative c' {
    \choralniRezim
    d4 c d d( f) f \barMin
    \mark\sipka g g f e f f d c c d c c \barMaior
    d d( f) e d c d d \barFinalis
...
\score {
  \relative c'' {
    ...
    c b a b g g \barMaior
    a g f g( a) a \barMin
    c a a \mark\sipka a( b) g g \barFinalis
...
\score {
  \relative c' {
    \choralniRezim
    f4 g g( a) g f f( g) g \barMaior
    bes a g( a) g g \barMin
    g f d f g a a g( f) f \barFinalis
...
\score {
  \relative c'' {
    ...
    d \mark\sipka f( e) d( e) d \barMin d c a a c b a( g) g \barFinalis
...
\score {
  \relative c'' {
    ...
    a b( c) a a \barMin a c a a c b a( g) g \barFinalis
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c c( d) \mark\sipka d c c \barMin
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c( d c) \barMin b c a \mark\sipka g a( c) b \barMaior
    a b c a( g f4.) f4 \barMin
    g a a g \barFinalis
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c( d c) \barMin b c a g a( c) b \barMaior
    a b c \mark\sipka a( g a4.) g4 \barMin
    a f a g \barFinalis
...
\score {
  \relative c' {
    ...
    \key f \major
    f4( a) g g \barMin a bes a g a f d( e) d \barMaior
    f \mark\sipka f g bes bes bes a( g) a \barMaior
    bes( g a f) d \barMin d d( e) c c d d \barFinalis
...
\score {
  ...
  \header {
    ...
    differentia = "a"
    psalmus = ""
    placet = "jednotvárná; začátek divný; _kříž_ špatně nese dlouhé melisma"
    id = "rch-aben1"
    piece = \markup {\sestavTitulekBezZalmu}
  }
}
...
\score {
  \relative c'' {
    ...
    \mark\sipka g f e f( d c) c \barMin
    d d( f e) d c d d d \barFinalis
...
\score {
  \relative c' {
    \choralniRezim
    c4 d f \mark\sipka g a f g g \barMaior
    a( bes) a g f g( a) a( g) g \barFinalis
...
\score {
  \relative c' {
    \choralniRezim
    d4 d c f g f( a) a \barMin
    g f g( a g4.) g \barMaior
    a4 g \mark\sipka f e f d( c) \barMaior
    c d f( g) f f \barMin
    f e c e( f) d d \barFinalis
...
\score {
  \relative c'' {
    \choralniRezim
    c4 \mark\sipka d( e) d c c( d) d \barMin
    d c( d) c b a( g) \barMin
...
\score {
  \relative c'' {
    \choralniRezim
    a4 a c d c c( d) d \barMin d c b a( g a) a( g) \barMaior
    \mark\sipka f g a b( c) a a c d e e( d) d \barMaior
...
\score {
  \relative c'' {
    \choralniRezim
    a4 a c d c c( d) d \barMin d c b \mark\sipka a( g) a( g) \barMaior
    f g a b( c) a a \mark\sipka c d c d( e) d \barMaior
    c-- b c a g( a) a \barFinalis
...
\score {
  \relative c' {
    ...
    a g f e( f) d d f \mark\sipka g a g g \barMaior
...
\score {
  \relative c'' {
    ...
    \choralniRezim
    c4 d d d c b a( g) g \barMaior
    a f( g a4.) a \barMin c4 c \mark\sipka c b g g \barFinalis
...
\score {
  \relative c'' {
    \choralniRezim
    g4 a a a g f g( a) \mark\sipka a \barMaior
    c b( c a4.) a4 \barMin
    c c b a g g \barFinalis
...
\score {
  \relative c' {
    ...
    \neviditelna f
    f4 f f g f f f g( a) a( g) \barMax
    g \mark\sipka f g( a) g \barMin g a g( f) d d f g g( f) f \barFinalis
    % V
    \neviditelna a
    a4( bes) a g( a) \barMin a a g( a) g g \barMaior
    g g g g \mark\sipka a g f g a a( g) \barMax
    % R
    \neviditelna a
    g \mark\sipka f g( a) g \barMin g a g( f) d d f g g( f) f \barFinalis
    % Slava
...
\score {
  \relative c' {
    \choralniRezim
    d4 d d d( f d) c( d) d \barMin
    \mark\sipka d c d f g f d e d( c) \barMaior
    d c d( f) f \barMin f e c e f d d \barFinalis
...
\score {
  \relative c'' {
    ...
    c4 b a c( d) e( d) d \barMin
    e( f e d) c( d) d \barMin d c b g a a( g) \barMaior
    \mark\sipka f g a( c) c \barMin c b g a g f( g) g \barFinalis
...
\score {
  \relative c'' {
    ...
    d c d c b a g g \barMaior
    g a g f g( a) \barMin \mark\sipka g f g a g g \barFinalis
...
\score {
  \relative c'' {
    ...
    g4 a c c b a c( d) \barMin
    d c d c b a g g \barMaior
    \mark\sipka a a g f g( a) \barMin \mark\sipka c c b a g g \barFinalis
...
\score {
  \relative c'' {
    \choralniRezim
    g4 a c c b \mark\sipka c a \barMin
    a c b a g a g g \barMaior
    g f g a a( c) \barMin b c a a g g \barFinalis
...
\score {
  \relative c'' {
    \choralniRezim
    g4 a c c b c a \barMin
    a c b a g a g g \barMaior
    g \mark\sipka a g f g( a) \barMin c c c b g g \barFinalis
