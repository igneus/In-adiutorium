...
\score {
  \relative c'' {
    ...
    c4 c c b g a( g f g) g \barFinalis
  }
  \addlyrics {
    V_Hos -- po -- di -- no -- vě chrá -- mě
...
\score {
  \relative c'' {
    ...
    \mark\sipka e4 d c( d) c a b( c a g) g \barFinalis
  }
  \addlyrics {
    V_Hos -- po -- di -- no -- vě chrá -- mě
    všich -- ni vo -- la -- jí: Slá -- va!
...
\score {
  \relative c'' {
    \zvyraznovacZeleny
    \choralniRezim
    a4 g a c( d) d \barMin e d c d( e) d \barMaior
...
\score {
  \relative c'' {
    \zvyraznovacModry
    \choralniRezim
    a4 g a c( d) d \barMin \mark\sipka f e c d c \barMaior
    d( e d) c( b) a( g) \barMin a g f g( a g) g \barFinalis
...
\score {
  \relative c'' {
    \choralniRezim
    \mark\sipka g4 g a a( c) c \barMin d c d d( e) d \barMaior
    d( e d) c( b) a( g) \barMin a g f g( a g) g \barFinalis
...
\score {
  \relative c'' {
    ...
    \choralniRezim
    g4 a c( d) d \barMin
    d \mark\sipka d c d e c c( d) d \barMaior
    d c( b) a( g) a( g) \barMin
    g f g a c c b c a g g \barMin
    a g f( g) g \barFinalis
  }
...
\score {
  \relative c'' {
    ...
    d c( b) a( g) a( g) \barMin
    \mark\sipka a g f g a a b c a g g \barMin
    a g f( g) g \barFinalis
  }
  \addlyrics {
    V_Bo -- žím měs -- tě
...
\score {
  \relative c'' {
    ...
    d d c d e c c( d) d \barMaior
    d c( b) a( g) a( g) \barMin
    \mark\sipka a b c a g g f g a g g \barMaior
    a g f( g) g \barFinalis
  }
  \addlyrics {
    V_Bo -- žím měs -- tě
...
\score {
  \relative c'' {
    ...
    g4 a c( d) d \barMin
    d d c d e c c( d) d \barMaior
    d c( b) a( g) \mark\sipka a \barMin
    a b c a g g f g a g g \barMaior
    a g f( g) g \barFinalis
  }
  \addlyrics {
    V_Bo -- žím měs -- tě
...
\score {
  \relative c' {
    \choralniRezim
    d4 d c c( d) d d f e d d \barMaior
    c d d( f) f \barMin f( g) f d d \barFinalis
  }
  \addlyrics {
    Bo -- že, tvá cír -- kev ti vzdá -- vá dí -- ky
    skr -- ze Kris -- ta, tvé -- ho Sy -- na.
...
\score {
  \relative c' {
    \choralniRezim
    d4 c d e( f) e d e c d d \barMaior
    f f e( f d) d \barMin d( e) c c( d) d \barFinalis
  }
  \addlyrics {
    Bo -- že, tvá cír -- kev ti vzdá -- vá dí -- ky
    skr -- ze Kris -- ta, tvé -- ho Sy -- na.
...
\score {
  \relative c'' {
    \choralniRezim
    g4 a c c( d) d d d( e) c c( d) d \barMaior
    \mark\sipka c b a( b) g \barMin f( g) a g g \barFinalis
  }
  \addlyrics {
    Bo -- že, tvá cír -- kev ti vzdá -- vá dí -- ky
    skr -- ze Kris -- ta, tvé -- ho Sy -- na.
...
\score {
  \relative c'' {
    ...
    c a b c a g f a g g \barFinalis
  }
  \addlyrics {
    Bo -- že, tvá cír -- kev ti vzdá -- vá dí -- ky
    skr -- ze Kris -- ta, tvé -- ho Sy -- na.
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c c d c b c a g g \barMaior
    f g g( a) a \barMin g( f) a g g \barFinalis
  }
  \addlyrics {
    Bo -- že, tvá cír -- kev ti vzdá -- vá dí -- ky
    skr -- ze Kris -- ta, tvé -- ho Sy -- na.
...
\score {
  \relative c'' {
    \choralniRezim
    g4 g g a g f g a g g \barMaior
    a c b( c) a \barMin g( f) a g g \barFinalis
  }
  \addlyrics {
    Bo -- že, tvá cír -- kev ti vzdá -- vá dí -- ky
    skr -- ze Kris -- ta, tvé -- ho Sy -- na.
...
\score {
  \relative c'' {
    \choralniRezim
    g4 a c c d e c c( d) d \barMin
    d d( e) d c c( d) c \barMaior
    a a g a c b a( g) g \barFinalis
...
\score {
  \relative c'' {
    \choralniRezim
    d4( f e c) c( d) \barMin c( a) b c d d \barMin
    c b g a( g) g \barMaior
    a a c b( c a) a \barMin a g f a4. g \barFinalis
...
\score {
  \relative c'' {
    \choralniRezim
    d4( c b a) a( b) \barMin g( a) c c c( d) d \barMin e f e d( c d) d \barMaior
    \mark\sipka d c b a g a( g) g \barFinalis
    f^\markup\rubrVelikAleluja g a( g) g \barFinalis
  }
  \addlyrics {
    Pojď -- me, klaň -- me se Kris -- tu, na -- še -- mu Pá -- nu;
...
\score {
  \relative c'' {
    \choralniRezim
    d4( c b a) a( b) \barMin g( a) c c c( d) d \barMin e f e d( c d) d \barMaior
    \mark\sipka d c( b) a( g) g f( g) a( g) g \barFinalis
    a^\markup\rubrVelikAleluja g f( g) g \barFinalis
  }
  \addlyrics {
    Pojď -- me, klaň -- me se Kris -- tu, na -- še -- mu Pá -- nu;
...
\score {
  \relative c'' {
    \choralniRezim
    d4( c b a) a( b) \barMin g( a) c c c( d) d \barMin e f e d( c d) d \barMaior
    \mark\sipka d d( e) c( d) d( c) \barMin
    a( g) a( b g) g \barFinalis
    a^\markup\rubrVelikAleluja g f( g) g \barFinalis
  }
  \addlyrics {
    Pojď -- me, klaň -- me se Kris -- tu, na -- še -- mu Pá -- nu;
...
\score {
  \relative c' {
    ...
    d4( f) f \barMin
    d( f) f f f( g) g \barMin f( g) f e d4. d \barMaior
    c4 f f e \mark\sipka c c( d) d \barFinalis
...
\score {
  \relative c' {
    ...
    \mark\sipka e^\markup\rubrVelikAleluja f d d \barFinalis
  }
  \addlyrics {
    Pojď -- me, klaň -- me se Kris -- tu, na -- še -- mu Pá -- nu;
    on mi -- lu -- je svou cír -- kev.
...
\score {
  \relative c' {
    ...
    d^\markup\rubrVelikAleluja f f f f e c
    e f d d \barFinalis
  }
  \addlyrics {
    Pojď -- me, klaň -- me se Kris -- tu, na -- še -- mu Pá -- nu;
    \markup{\Dagger on} mi -- lu -- je svou cír -- kev.
...
\score {
  \relative c' {
    ...
    \choralniRezim
    d4( f) d d f( g) f e d d \barMaior
    \mark\sipka c( d) d( f) f \barMin g f e d( e d) d \barFinalis
...
\score {
  \relative c'' {
    \zvyraznovacModry
    \choralniRezim
    c \mark\sipka d c a c b a g \barMin
    a a f e f g g \barFinalis
...
\score {
  \relative c'' {
    \choralniRezim
    b4 c d c b c( d) d \barMin
    d d \mark\sipka e d e( f) e d d \barMaior
    d c b c( a) a( g) g \barMin
    a g f g( a) a c b g g \bar ";"
...
\score {
  \relative c'' {
    ...
    \choralniRezim
    b4 c d c b c( d) d \barMin
    \mark\sipka c d e d e( f) e d d \barMaior
    d c b c( a) a( g) g \barMin
    a g f g( a) a c b g g \bar ";"
...
\markup\justify{
  Vysoká koncentrace hlásky M, včetně dvou M bezprostředně sousedících,
  na takto malém prostoru, činí text značně nezpěvným/jazykolamným.
}
...
\score {
  \relative c'' {
    \choralniRezim
    c4 d c( b) g( a) \barMin g f g( a) g g \barFinalis
...
\score {
  \relative c' {
    ...
    a' a g f g f d( f) e \barMin
    f g( a bes) a g bes a a \barMaior
    \mark\sipka bes( c bes a) g( a) \barMin f g f e d c f e d d \barMaior
...
\score {
  \relative c' {
    ...
    a' a g f g f \mark\sipka e( f d c) c \barMin
    d f( g a) g f a g g \barMaior
    a( bes a g) f( g) \barMin f g f e d c f e d d \barFinalis
...
\score {
  \relative c'' {
    ...
    c4 c( d) c c \barMin
    a c( b) a( g) g \barMaior
    a g f \mark\sipka g a b( c) a( g) g \barFinalis
...
\score {
  \relative c'' {
    ...
    c4 d d c
    b a( b) a( g) g \barMaior
    \mark\sipka a a a f( e) d f( g) a( g) g \barFinalis
...
\score {
  \relative c' {
    \choralniRezim
    f4 g a g a bes a a \barMin
    \mark\sipka g f g g( a) f f \barFinalis
...
\score {
  \relative c' {
    \choralniRezim
    \mark\sipka f4( g) f g a f g g \barMin
    f g f e d( c) c \barMaior
    d f g( f) f \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c' {
    \choralniRezim
    f4 f g a f g g \barMin
    \mark\sipka a a g f g( f d) c \barMaior
    d f g( f) f \barFinalis
  }
  \addlyrics {
    Chval -- te na -- še -- ho Bo -- ha,
...
\score {
  \relative c' {
    \zvyraznovacModry
    \choralniRezim
    f4 f g \mark\sipka f g g( a) a \barMin
    g a g f g( f d) c \barMaior
    d f g( f) f \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    ...
    \mark\sipka b^\markup\rubrVelikAleluja a g( a) a \barFinalis
  }
  \addlyrics {
    Sva -- tý je dům Bo -- ží:
    dům, v_němž se vzý -- vá Bo -- ží jmé -- no
...
\score {
  \relative c'' {
    ...
    \mark\sipka c^\markup\rubrVelikAleluja d c b a g g
    b c a a \barFinalis
  }
  \addlyrics {
    Sva -- tý je dům Bo -- ží:
