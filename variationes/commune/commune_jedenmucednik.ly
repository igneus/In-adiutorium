...
\score {
  \relative c' {
    ...
    f4 g a( g) f f( g) g \barMin
    a a a g a g( f) f \barMaior
    d f g \mark\sipka g f g( a) g g f f \barFinalis
...
\score {
  \relative c' {
    ...
    f4 g a( g) f f( g) g \barMin
    a a a g a g( f) f \barMaior
    d f g g f g( a) g \mark\sipka f( g) f f \barFinalis
...
\score {
  \relative c' {
    ...
    f4 g a( g) f f( g) g \barMin
    a a a g a g( f) f \barMaior
    d f g g f g( a) g f( g) \mark\sipka g( f) f \barFinalis
...
\score {
  \relative c' {
    ...
    d4 d d c d d f e f d d
    f g f( d) d \barMaior
    \mark\sipka d c a c d d d e( f) d d \barMin
...
\score {
  \relative c'' {
    \choralniRezim
    a4 g e g( a) \barMin b a g g( a) a \barMaior
    a \mark\sipka a c c b( c a) a c b a g( a) g \barMaior
...
\score {
  \relative c' {
    ...
    d4 d( e f d) d c d d( e) d \barMaior
    f f f( g) f \barMin g f e d( c) d d( c) \barMaior
    bes c d c d e \mark\sipka f f d d c e d d \barFinalis
...
\score {
  \relative c' {
    ...
    d4 d( e f d) d c d d( e) d \barMaior
    f f f( g) f \barMin g f e d( c) d d( c) \barMaior
    bes c d \mark\sipka d c d f( d) d \barMin e c a c d d \barFinalis

    f^\markup\rubrVelikAleluja f e d c c
    e f d d \barFinalis
  }
  \addlyrics {
    Pán zkou -- šel vy -- vo -- le -- né
...
\score {
  \relative c'' {
    ...
    c d e c( a) a \barMin b( c) a g a( g) g \barMaior
    a a a c a b c a( g) g \barMin
    f g a( g) g \barFinalis
...
\score {
  \relative c'' {
    ...
    g4 g a f g a g g \barMaior
    f g a g a c c \barMin
    c \mark\sipka b a g( a) g \barMin f( g) a a g g \barMaior
    a b c a a c b a( g) g \barMin
...
\score {
  \relative c'' {
    ...
    \mark\sipka c c c d c b c a( g) g \barMin
