...
\score {
  \relative c' {
    \choralniRezim
    d4 \bar "" d c \bar "" d \bar "" d( a' bes) a a \mark\sipka g \bar "" f g \bar "" g( a) a \barMax
  }
  \addlyrics {
    Kéž bys -- te dnes u -- po -- slech -- li je -- ho hla -- su:
  }
...
\score {
  \relative c' {
    \choralniRezim
    \mark\sipka d4 \bar "" d c \bar "" d \bar "" d( a' bes) a a a \bar "" a g \bar "" a( bes a) a \barMax
  }
  \addlyrics {
    Kéž bys -- te dnes u -- po -- slech -- li je -- ho hla -- su:
  }
...
\score {
  \relative c' {
    \choralniRezim
    d4 \bar "" d c \bar "" d \bar "" d( a' bes) a \mark\sipka g f \bar "" g a \bar "" a( g) g \barMax
    f g a a a \bar ""
  }
  \addlyrics {
    Kéž bys -- te dnes u -- po -- slech -- li je -- ho hla -- su:
