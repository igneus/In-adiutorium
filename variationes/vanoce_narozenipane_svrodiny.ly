...
\bookpart {
  ...
  \score {
    \relative c'' {
      ...
      d d( e c d) d \barMin
      d c( b) a( g) g( a) a \barMaior
      a g a \mark\sipka a( b) g g \barFinalis
    }
    \addlyrics {
      Jo -- se -- fe,
      sy -- nu Da -- vi -- dův,
  ...
  \score {
    \relative c'' {
      \choralniRezim
      d4 d b d e d c b c a( g) g \barMaior
    }
    \addlyrics {
      Pas -- tý -- ři po -- spí -- cha -- li do Bet -- lé -- ma.
      Na -- lez -- li Ma -- ri -- i a Jo -- se -- fa
  ...
  \score {
    \relative c'' {
      \choralniRezim
      c4 c c b c a g a g f( g) g \barMaior
      a g f g a a c b( c) a a \barMaior
      c b( c) a( g) g \barMin
      a g f a a( g) g \barFinalis
    }
    \addlyrics {
  ...
  \score {
    \relative c'' {
      \choralniRezim
      c4 c c b c a g a g f( g) g \barMaior
      a g f \mark\sipka a c b a c d c \barMaior
      c d( e) d( c) c \barMin
  ...
  \score {
    \relative c'' {
      \choralniRezim
      c4 c c b c a g a g f( g) g \barMaior
      \mark\sipka a a a c b a c c d d \barMaior
      d c( d) d( c) c \barMin
      b c a g f( g) g \barFinalis
    }
    \addlyrics {
  ...
  \score {
    \relative c'' {
      \choralniRezim
      c4 c c b c a g a g f( g) g \barMaior
      a a a c b a \mark\sipka g a c b \barMaior
      c c( d) d( c) c \barMin
      b c a g f( g) g \barFinalis
    }
    \addlyrics {
  ...
  \score {
    \relative c'' {
      \choralniRezim
      g4 g g a a g f g( a) a g g \barMaior
      a c b c d c b c( a) g g \barMaior
      a f( e) d d \barMin
  ...
  \score {
    \relative c' {
      ...
      d e f e d c c \barMaior
      f f f g f f f g( a) g f d d \barMaior
      \mark\sipka d d c d d( f) f f e( f) d d \barFinalis
    }
    \addlyrics {
      Chla -- pec Je -- žíš
      zů -- stal v_Je -- ru -- za -- lé -- mě,
  ...
  \score {
    \relative c' {
      \choralniRezim
      f4 g g( a) \barMin
      a g( a) g \mark\sipka f g a a( g) g \barMaior
  ...
  \score {
    \relative c' {
      ...
      c d \mark\sipka c d f e c( d) d \barFinalis
    }
    \addlyrics {
      Jo -- sef vstal,
      vzal dí -- tě i je -- ho mat -- ku
  ...
  \score {
    \relative c' {
      ...
      c4 d d( f) \barMin
      f f( g) f e f d d( c) c \barMaior
      d f \mark\sipka f d( e) d( c) \barMin
      c d f f e c c( d) d \barFinalis
    }
    \addlyrics {
      Jo -- sef vstal,
  ...
  \score {
    \relative c' {
      ...
      c4 d d( f) \barMin
      f f( g) f e f d d( c) c \barMaior
      d f f \mark\sipka f( g) g( f) \barMin
      f f d d f e c( d) d \barFinalis
    }
    \addlyrics {
      Jo -- sef vstal,
      vzal dí -- tě i je -- ho mat -- ku
  ...
  \score {
    \relative c' {
      \choralniRezim
      c4 d d( f) \barMin
      f f( g) \mark\sipka g g f g g( f) f \barMaior
      f d f e( d) c \barMin
      c d f f e c c( d) d \barFinalis
    }
    \addlyrics {
  ...
  \score {
    \relative c' {
      ...
      \choralniRezim
      c4 d d( f) \barMin
      f \mark\sipka g( a) g f e f d( c) c \barMaior
      d c d d( f) f \barMin
  ...
  \score {
    \relative c' {
      \choralniRezim
      \mark\sipka f4 d d e( f) d( c) c \barMaior
      d d c d f g g \barMin
      a g f a a f e d( e) d d \barMaior
