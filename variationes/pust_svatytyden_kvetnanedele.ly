...
\score {
  \relative c'' {
    ...
    c c c c c( d) c c \barMin
    c c \mark\sipka b c a g a g g \barMaior
    a f( e) d d \barMin
    f( g) a( c) c b g a( g) g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    \zvyraznovacModry
    \choralniRezim
    a4 a \mark\sipka b g a g( f) e e \barMaior
    c d d( e) e \barMin
    f g a a g f g g e e \barMaior
    a a b( c) a \barMin g a g f e e \barMaior
    f g e \barFinalis
...
\score {
  \relative c'' {
    \choralniRezim
    a4 a a \mark\sipka c c b a g( a) g g \barMin b( c) a a \barMaior
    a4 a a( d) d \barMin d c( d) c( a) a \barMin b( c) a a g( a) a \barMaior
    g e e g a g( a) a \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    \choralniRezim
    a4 g a c c b a b a g b( c) a a \barMaior
    g4 a a( c) c \barMin d c( b) a a \barMin b c a g( a) g \barMaior
...
\score {
  \relative c'' {
    ...
    f g g a a a g a c b a g a \barMaior
    a( c) c b( c) a a \barMin
    a b( g e4.) e \barMin
    d4 f f( e) e \barFinalis
  }
...
\score {
  \relative c' {
    ...
    \key f \major
    \choralniRezim
    d4 d \mark\sipka d( f d) c f g a( g) g \barMaior
    a g g g a( bes c) bes( a) g \barMin
    a( g f) g f( d) d \barMaior
    c d e( f) d d \barMaior
    f g a f g \barMin
...
\score {
  \relative c' {
    ...
    g f e d c \barMaior
    d f g f( e) d \barMin
    f g( a g f) \mark\sipka d( c) \barMin
    f e c( d) d \barFinalis
  }
  \addlyrics {
    Ce -- lý zá -- stup u -- čed -- ní -- ků
...
\score {
  ...
  \header {
    ...
    differentia = "c"
    psalmus = "Žalm 115"
    placet = "akcent na _Kristova_ nějak nejde do pusy,
    podle všeho to souvisí s tím, že mu předchází jenom jedna slabika"
    id = "ne-2ne-a2"
    piece = \markup {\sestavTitulek}
  }
}
...
\score {
  \relative c'' {
    \zvyraznovacModry
    \choralniRezim
    c4 d \mark\sipka d c b c a g g \barMaior
    a a a g f g( a) a \barMin
    a c b g g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c'' {
    \choralniRezim
    a4 \mark\sipka a g4.( a) g4 f e( f d) d \barMin
    d c d f e f( g) g g f g g( a) a \barMaior
    a a a a a g f e4. e \barMin
    d4 e f g f d d \barFinalis
  }
