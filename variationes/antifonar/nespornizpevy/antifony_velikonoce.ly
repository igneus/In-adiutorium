...
\score {
  \relative c' {
    \choralniRezim
    d4( f) f \barMin f g a g f f g f d d \barMaior
    c d f4.( g4 a) f4( e) c( d) d \barMaior
    c d e d \barFinalis
  }
  \addlyrics {
    Pojď -- te_* a po -- dí -- vej -- te se na to mís -- to, 
...
\score {
  \relative c'' {
    \choralniRezim
    g4( a) a \barMin a g a g f e a g e e \barMaior
...
\score {
  \relative c'' {
    ...
    \choralniRezim
    g4 g g f( e f) g( a) a a b( c) c c \barMin
    c b4.( g) g4 \mark\sipka a( g) f g g \barMax
    g4 g( a) g4. g \barFinalis
  }
  \addlyrics {
    Ny -- ní je o -- sla -- ven Syn člo -- vě -- ka
