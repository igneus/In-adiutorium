...
\score {
  \relative c' {
    \choralniRezim
    d4 d d( a') a \barMin a b c b a g a4. e \barMaior
    d4( e) e \barMin \mark\sipka e e f g f e g a a \barMaior
    a4 a a g a a( b) g g \barMin a \mark\sipka a a g a g f e e \barMaior
    e d( c d) e( f) e e \mark\sipka f( g) a g e e \barFinalis
  }
  \addlyrics {
    Sva -- tý Ví -- te,
    slav -- ný Kris -- tův mu -- čed -- ní -- ku,
