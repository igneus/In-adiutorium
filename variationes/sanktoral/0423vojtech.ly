...
\score {
  \relative c' {
    ...
    c d e d d \barMaior
    d f e f( g) g \barMin
    g g g a g f e( f) d( c) c \mark\sipka \barMaior
    d d c d f e f d \mark\sipka d( c) \barMin
    d f e c( d) d \barMaior
    e f d( c) d \barFinalis
  }
  \addlyrics {
