...
\markup\justify{
  Druhá z tohoto páru antifon je dle mého soudu mizerně přeložená.
  "\"Svědčit o pravdě\"" se česky prostě neříká.
  Dá se vydat pravdivé svěděctví, dosvědčit, že někdo jiný říká pravdu,
  příp. vydat svědectví o Pravdě.
  Latinský originál zní \italic{Hic venit ut testimónium perhibéret veritáti.}
}
