...
\score {
  \relative c'' {
    ...
    c d c c d b a( g) g \barMaior
    a f e d( e) d d \barMin
    \mark\sipka f g a a c b a g a( g) g \barFinalis
  }
  \addlyrics {
    Ra -- duj -- te se
    a dě -- kuj -- te spo -- lu se mnou,
...
\score {
  \relative c'' {
    ...
    f g g( a) a \barMin
    \mark\sipka a b c a g g( a) g g \barFinalis
  }
  \addlyrics {
    Ve -- le -- bím tě,
    Ot -- če mé -- ho Pá -- na
...
\score {
  \relative c'' {
    ...
    c c c( d) c a a \barMin
    c b a g( a) g \barMaior
    \mark\sipka a a g a g f g( a) \barMin
...
\score {
  \relative c'' {
    ...
    \choralniRezim
    g4 a a( c) c \barMin
    c \mark\sipka b c( d) d c c \barMin
    b c a g( a) g \barMaior
    a a g a g f \mark\sipka g( f d) \barMin
...
\score {
  \relative c' {
    \zvyraznovacSedy
    \choralniRezim
    \mark\sipka c4 d e( f d) c( d) d \barMaior
    \stemUp d( a' bes) a a a( c) \mark\sipka a g( a) a \barMin
    f g f d d \barMax
...
\score {
  \relative c' {
    ...
    \mark\sipka f( g) g( a) a a( c) a g( a) a \barMin
    f g f d d \barMax

    f4 g f( d) d \barMin
    f d d f e d( c) c \barMaior
    f g a a( bes a) g( a) a \barMin
    a a \mark\sipka g f g a g f g( f e) d( c) c \barMaior
    d d \mark\sipka c d( f) g f( e) d d \barFinalis
  }
  \addlyrics {
    Sva -- tá A -- než -- ka
    po -- zved -- la ru -- ce k_ne -- bi
