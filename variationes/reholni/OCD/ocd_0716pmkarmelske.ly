...
\score {
  \relative c'' {
    \choralniRezim
    c4 c c b( c) a \mark\sipka g a g f( g) g \barMaior
...
\score {
  \relative c'' {
    ...
    c4 c c b( c) a a b a a( g) g \barMaior
    f g a c c c d c a a \barMin
    \mark\sipka a c b a g a g f g g \barFinalis
  }
  \addlyrics {
    Bu -- deš se ra -- do -- vat ze svých sy -- nů,
    ne -- boť v_to -- bě bu -- dou po -- žeh -- ná -- ni
...
\score {
  \relative c'' {
    ...
    c4 c c b( c) a a b a a( g) g \barMaior
    f g a c c c d c a a \barMin
    \mark\sipka c c b a g a g f g g \barFinalis
  }
  \addlyrics {
    Bu -- deš se ra -- do -- vat ze svých sy -- nů,
    ne -- boť v_to -- bě bu -- dou po -- žeh -- ná -- ni
...
\score {
  \relative c'' {
    \choralniRezim
    g4 f g a c c \barMin b a g( a g) g \barMaior
    a g a c c c d c a a \barMin
    c b a g g a g f g g \barFinalis
  }
  \addlyrics {
...
\score {
  \relative c' {
    ...
    % V
    \neviditelna a
    a4 a \mark\sipka g( a) g g f g a a( g) \barMax
    % R
    \neviditelna f
    f d f( g) g( f) f \barFinalis
    % Slava
...
\score {
  \relative c' {
    ...
    % V
    \neviditelna a
    a4 a g( a) g g f g \mark\sipka g( a) a( g) \barMax
    % R
    \neviditelna f
    f d f( g) g( f) f \barFinalis
    % Slava
...
\score {
  \relative c' {
    ...
    d4 d c f g f( a) a \barMin
    a( c b g) g f( g) f g( a) a \barMaior
    a a \mark\sipka a a g a c b a a \barMin
    g( a) g f( e d c) c \barMaior
    d f \mark\sipka g( a) g f g g( f) \barMin
    f f e c \mark\sipka f e c( d) d \barFinalis
  }
  \addlyrics {
    Vzne -- še -- ná Mat -- ko Bo -- ží,
    slá -- vo ho -- ry Kar -- mel,
...
\score {
  \relative c' {
    ...
    d4 e f f f f e d c c f( g) f g a a \barMin
    a( c) b a( g) g( a) a \barMaior
    a g f e \mark\sipka c e( f d4.) d \barFinalis
  }
  \addlyrics {
    Při -- po -- mí -- nej -- me si dob -- ro -- di -- ní Pan -- ny Ma -- ri -- e,
    Mat -- ky Kar -- me -- lu,
...
\score {
  \relative c' {
    ...
    f4 g g( a) a \barMin
    a a g f g( a g) g \barMaior
    g \mark\sipka a a g f e( f) d( c) c \barMin
    d f g g g( a) g( f) f \barFinalis
  }
  \addlyrics {
    Při -- ve -- du je
...
\score {
  \relative c' {
    ...
    d c \mark\sipka f e d( e d) d \barFinalis
  }
  \addlyrics {
    Slav -- né vě -- ci se o to -- bě vy -- pra -- vu -- jí,
    měs -- to Bo -- ží;
...
\score {
  \relative c'' {
    ...
    g4 g g( a) g \barMin
    c c c b a a( g) g \barMaior
    c d e d \mark\sipka c( d) c c \barMin
...
\score {
  \relative c' {
    ...
    d c f e( d) d \barMaior
    d e f d( c) c \barMin
    d c d f f e \mark\sipka c c( d) d \barFinalis
  }
  \addlyrics {
    Je -- žíš ře -- kl své mat -- ce:
    „Že -- no, to je tvůj syn.“
...
\score {
  \relative c' {
    ...
    e( c) c( d) d \barMaior
    c d( f) f \barMin
    f f f f \mark\sipka g f e d \barMin
...
\score {
  \relative c'' {
    \choralniRezim
    a4 a a g a g g a b c a a \barMaior
    c b a b \mark\sipka a g g( a) a \barMaior
    a a g f e f d d \barFinalis
  }
  \addlyrics {
    Ma -- ri -- a na -- slou -- cha -- la Bo -- ží -- mu slo -- vu,
...
\score {
  \relative c'' {
    \choralniRezim
    c4 c c b a g g f g a a( g) g \barMaior
    a b c d c a g g \barMin
...
\score {
  \relative c' {
    ...
    \neviditelna f
    f4 f f f f f f g f g( a) a( g) \barMax
    g \mark\sipka g g f d f g \mark\sipka g f \barFinalis
    % V
    \neviditelna a
    a4 a a a( bes) a a a a g( a) g \barMaior
    g g g a g g f g a a( g) \barMax
...
\score {
  \relative c' {
    ...
    c' d( e) d d( c) c \barMin
    b( c a g) a( g) \barMin a g f g g( a) g g \barMaior
    \mark\sipka f g g a a \barMin c b c d c b c( a) g g \barMin
